...
export class BounceControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getBouncedEmail1(id: string, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError('Required parameter id was null or undefined when calling getBouncedEmail1.');
        }
...
export class BounceControllerApiResponseProcessor {
     ...
     */
     public async getBouncedEmail(response: ResponseContext): Promise<void | Bounce > {
        ...
        if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
            const body: void | Bounce = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "void | Bounce", ""
            ) as void | Bounce;
            return body;
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getBouncedEmail1
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getBouncedEmail1(response: ResponseContext): Promise<BounceRecipient | void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return;
        }
        ...
        // Work around for missing responses in specification, e.g. for petstore.yaml
        if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
            const body: BounceRecipient | void = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "BounceRecipient | void", ""
            ) as BounceRecipient | void;
            return body;
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getBouncedEmails(response: ResponseContext): Promise<void | PageBouncedEmail > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return;
        }
        ...
        // Work around for missing responses in specification, e.g. for petstore.yaml
        if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
            const body: void | PageBouncedEmail = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "void | PageBouncedEmail", ""
            ) as void | PageBouncedEmail;
            return body;
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getBouncedRecipients(response: ResponseContext): Promise<void | PageBouncedRecipients > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            return;
        }
        ...
        // Work around for missing responses in specification, e.g. for petstore.yaml
        if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
            const body: void | PageBouncedRecipients = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "void | PageBouncedRecipients", ""
            ) as void | PageBouncedRecipients;
            return body;
        }
