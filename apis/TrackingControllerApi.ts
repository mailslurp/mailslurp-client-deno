...
export class TrackingControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAllTrackingPixels(before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
