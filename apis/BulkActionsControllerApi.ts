...
export class BulkActionsControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param ids ids
     */
    public async bulkDeleteInboxes(ids: Array<string>, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'ids' is not null or undefined
        if (ids === null || ids === undefined) {
            throw new RequiredError('Required parameter ids was null or undefined when calling bulkDeleteInboxes.');
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(ids, "Array<string>", ""),
            contentType
        );
...
export class BulkActionsControllerApiResponseProcessor {
     ...
     */
     public async bulkCreateInboxes(response: ResponseContext): Promise<Array<Inbox> > {
