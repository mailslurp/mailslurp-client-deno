...
export class MissedEmailControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAllMissedEmails(before?: Date, inboxId?: string, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public async getAllUnknownMissedEmails(before?: Date, inboxId?: string, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     */
    public async waitForNthMissedEmail(before?: Date, inboxId?: string, index?: number, since?: Date, timeout?: number, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
