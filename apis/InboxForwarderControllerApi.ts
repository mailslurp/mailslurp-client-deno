...
export class InboxForwarderControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createNewInboxForwarder(inboxId: string, createInboxForwarderOptions: CreateInboxForwarderOptions, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'inboxId' is not null or undefined
        if (inboxId === null || inboxId === undefined) {
            throw new RequiredError('Required parameter inboxId was null or undefined when calling createNewInboxForwarder.');
        }
     ...
     */
    public async getAllInboxForwarderEvents(page?: number, size?: number, inboxId?: string, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
