...
export class WaitForControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async waitForEmailCount(count?: number, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param unreadOnly Optional filter for unread only.
     */
    public async waitForLatestEmail(delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public async waitForMatchingEmails(matchOptions: MatchOptions, count?: number, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public async waitForMatchingFirstEmail(matchOptions: MatchOptions, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public async waitForNthEmail(delay?: number, inboxId?: string, index?: number, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
