...
export class WaitForControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async waitForEmailCount(before?: Date, count?: number, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param unreadOnly Optional filter for unread only.
     */
    public async waitForLatestEmail(before?: Date, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public async waitForMatchingEmails(matchOptions: MatchOptions, before?: Date, count?: number, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public async waitForMatchingFirstEmail(matchOptions: MatchOptions, before?: Date, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public async waitForNthEmail(before?: Date, delay?: number, inboxId?: string, index?: number, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
...
export class WaitForControllerApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async waitForMatchingEmails(response: ResponseContext): Promise<Array<EmailPreview> | void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<EmailPreview> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
