...
export class WaitForControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public async waitForMatchingEmail(matchOptions: MatchOptions, count?: number, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
