...
export class SentEmailsControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAllSentTrackingPixels(before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public async getSentEmailTrackingPixels(id: string, before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public async getSentEmails(before?: Date, inboxId?: string, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public async getSentOrganizationEmails(before?: Date, inboxId?: string, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
