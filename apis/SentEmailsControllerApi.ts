...
export class SentEmailsControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAllSentTrackingPixels(page?: number, searchFilter?: string, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public async getSentEmailTrackingPixels(id: string, page?: number, searchFilter?: string, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
