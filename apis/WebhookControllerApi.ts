...
export class WebhookControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAllWebhookResults(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public async getWebhookResults(webhookId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
