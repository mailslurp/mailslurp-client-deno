...
export class WebhookControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAllWebhookResults(before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', unseenOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param unseenOnly Filter for unseen exceptions only
     */
    public async getWebhookResults(webhookId: string, before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', unseenOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param inboxId inboxId
     */
    public async getWebhookResultsUnseenErrorCount(inboxId: string, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'inboxId' is not null or undefined
        if (inboxId === null || inboxId === undefined) {
            throw new RequiredError('Required parameter inboxId was null or undefined when calling getWebhookResultsUnseenErrorCount.');
        }
