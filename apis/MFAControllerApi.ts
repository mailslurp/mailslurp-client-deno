...
export class MFAControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createTotpDeviceForBase32SecretKey(createTotpDeviceBase32SecretKeyOptions: CreateTotpDeviceBase32SecretKeyOptions, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'createTotpDeviceBase32SecretKeyOptions' is not null or undefined
        if (createTotpDeviceBase32SecretKeyOptions === null || createTotpDeviceBase32SecretKeyOptions === undefined) {
            throw new RequiredError('Required parameter createTotpDeviceBase32SecretKeyOptions was null or undefined when calling createTotpDeviceForBase32SecretKey.');
        }


        // Path Params
        const localVarPath = '/mfa/totp/device/base32SecretKey';
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(createTotpDeviceBase32SecretKeyOptions, "CreateTotpDeviceBase32SecretKeyOptions", ""),
            contentType
        );
     ...
     */
    public async createTotpDeviceForCustom(createTotpDeviceCustomOptions: CreateTotpDeviceCustomOptions, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'createTotpDeviceCustomOptions' is not null or undefined
        if (createTotpDeviceCustomOptions === null || createTotpDeviceCustomOptions === undefined) {
            throw new RequiredError('Required parameter createTotpDeviceCustomOptions was null or undefined when calling createTotpDeviceForCustom.');
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(createTotpDeviceCustomOptions, "CreateTotpDeviceCustomOptions", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
...
export class MFAControllerApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to createTotpDeviceForBase32SecretKey
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createTotpDeviceForBase32SecretKey(response: ResponseContext): Promise<TotpDeviceDto > {
