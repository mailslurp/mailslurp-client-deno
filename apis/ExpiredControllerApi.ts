...
export class ExpiredControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getExpiredInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, inboxId?: string, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
