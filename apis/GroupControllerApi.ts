...
export class GroupControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async addContactsToGroup(groupId: string, updateGroupContactsOption: UpdateGroupContacts, options?: Configuration): Promise<RequestContext> {
        ...
        if (updateGroupContactsOption === null || updateGroupContactsOption === undefined) {
            throw new RequiredError('Required parameter updateGroupContactsOption was null or undefined when calling addContactsToGroup.');
        }
        ...
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(updateGroupContactsOption, "UpdateGroupContacts", ""),
            contentType
        );
     ...
     */
    public async getAllGroups(before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public async getGroupWithContactsPaginated(groupId: string, before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param updateGroupContactsOption updateGroupContactsOption
     */
    public async removeContactsFromGroup(groupId: string, updateGroupContactsOption: UpdateGroupContacts, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
        ...
        // verify required parameter 'updateGroupContactsOption' is not null or undefined
        if (updateGroupContactsOption === null || updateGroupContactsOption === undefined) {
            throw new RequiredError('Required parameter updateGroupContactsOption was null or undefined when calling removeContactsFromGroup.');
        }
...
export class GroupControllerApiResponseProcessor {
     ...
     */
     public async addContactsToGroup(response: ResponseContext): Promise<void | GroupContactsDto > {
        ...
        if (response.httpStatusCode >= 200 && response.httpStatusCode <= 299) {
            const body: void | GroupContactsDto = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "void | GroupContactsDto", ""
            ) as void | GroupContactsDto;
            return body;
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async removeContactsFromGroup(response: ResponseContext): Promise<void | GroupContactsDto > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GroupContactsDto = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
