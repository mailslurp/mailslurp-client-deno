...
export class AttachmentControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAttachments(page?: number, size?: number, sort?: 'ASC' | 'DESC', fileNameFilter?: string, since?: Date, before?: Date, inboxId?: string, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param filename2 
     */
    public async uploadAttachmentBytes(contentType?: string, contentType2?: string, contentId?: string, filename?: string, filename2?: string, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param inlineObject 
     */
    public async uploadMultipartForm(contentId?: string, contentType?: string, filename?: string, xFilename?: string, inlineObject?: InlineObject, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
