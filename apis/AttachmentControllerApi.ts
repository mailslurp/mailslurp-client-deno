...
export class AttachmentControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async uploadAttachmentBytes(inlineObject1: InlineObject1, contentType?: string, filename?: string, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'inlineObject1' is not null or undefined
        if (inlineObject1 === null || inlineObject1 === undefined) {
            throw new RequiredError('Required parameter inlineObject1 was null or undefined when calling uploadAttachmentBytes.');
        }
