...
export class AttachmentControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAttachments(before?: Date, fileNameFilter?: string, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
