...
export class AttachmentControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAttachments(page?: number, size?: number, sort?: 'ASC' | 'DESC', fileNameFilter?: string, since?: Date, before?: Date, inboxId?: string, emailId?: string, sentEmailId?: string, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param inlineObject 
     */
    public async uploadMultipartForm(contentId?: string, contentType?: string, filename?: string, contentTypeHeader?: string, xFilename?: string, xFilenameRaw?: string, xFilesize?: number, inlineObject?: InlineObject, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
