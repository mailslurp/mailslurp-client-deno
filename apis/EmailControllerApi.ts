...
export class EmailControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getEmailsPaginated(before?: Date, inboxId?: Array<string>, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * @param unreadOnly Optional filter for unread emails only. All emails are considered unread until they are viewed in the dashboard or requested directly
     */
    public async getOrganizationEmailsPaginated(before?: Date, inboxId?: Array<string>, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
