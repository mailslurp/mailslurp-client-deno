...
export class EmailControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async sendEmailSourceOptional(sendEmailOptions: SendEmailOptions, inboxId?: string, useDomainPool?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
