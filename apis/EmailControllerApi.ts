...
export class EmailControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param decode 
     */
    public async getEmailHTMLJson(emailId: string, decode?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     */
    public async sendEmailSourceOptional(inboxId: string, sendEmailOptions: SendEmailOptions, useDomainPool?: boolean, virtualSend?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
