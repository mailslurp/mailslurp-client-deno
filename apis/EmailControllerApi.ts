...
export class EmailControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getLatestEmail(inboxIds?: Set<string>, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
        ...
        if (inboxIds !== undefined) {
            requestContext.setQueryParam("inboxIds", ObjectSerializer.serialize(inboxIds, "Set<string>", "uuid"));
        }
     ...
     */
    public async sendEmailSourceOptional(inboxId: string, sendEmailOptions: SendEmailOptions, useDomainPool?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'inboxId' is not null or undefined
        if (inboxId === null || inboxId === undefined) {
            throw new RequiredError('Required parameter inboxId was null or undefined when calling sendEmailSourceOptional.');
        }
...
export class EmailControllerApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async downloadAttachment(response: ResponseContext): Promise<Array<string> > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async downloadBodyBytes(response: ResponseContext): Promise<Array<string> > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<string> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
