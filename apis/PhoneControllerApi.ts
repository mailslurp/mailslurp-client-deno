...
export class PhoneControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getPhoneNumbers(phoneCountry?: 'US' | 'GB' | 'AU', page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, search?: string, include?: Array<string>, favourite?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
        ...
        if (phoneCountry !== undefined) {
            requestContext.setQueryParam("phoneCountry", ObjectSerializer.serialize(phoneCountry, "'US' | 'GB' | 'AU'", ""));
        }
        if (page !== undefined) {
