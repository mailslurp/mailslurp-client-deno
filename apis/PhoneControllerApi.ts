...
export class PhoneControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * Get a phone number by name
     */
    public async getPhoneNumberByName(options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
     ...
     * Get a phone number by phone number
     */
    public async getPhoneNumberByPhoneNumber(options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
