...
export class PhoneControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getPhoneNumbers(phoneCountry?: 'US' | 'GB' | 'AU', page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
