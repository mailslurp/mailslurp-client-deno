...
export class SmsControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getAllSmsMessages(phoneNumber?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, search?: string, favourite?: boolean, include?: Array<string>, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
