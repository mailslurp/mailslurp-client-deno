...
export class FormControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async submitForm(to?: string, subject?: string, emailAddress?: string, successMessage?: string, spamCheck?: string, otherParameters?: string, options?: Configuration): Promise<RequestContext> {
