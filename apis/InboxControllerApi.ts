...
export class InboxControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getEmails(inboxId: string, delayTimeout?: number, limit?: number, minCount?: number, retryTimeout?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
