...
export class InboxControllerApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async createInboxRuleset(inboxId: string, createRulesetOptions: CreateRulesetOptions, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
        ...
        if (createRulesetOptions === null || createRulesetOptions === undefined) {
            throw new RequiredError('Required parameter createRulesetOptions was null or undefined when calling createInboxRuleset.');
        }
     ...
     * @param sender Sender
     */
    public async doesInboxExist(emailAddress: string, allowCatchAll?: boolean, ipAddress?: string, sender?: string, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
...
export class InboxControllerApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createInboxRuleset(response: ResponseContext): Promise<RulesetDto > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listInboxRulesets(response: ResponseContext): Promise<PageRulesetDto > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
