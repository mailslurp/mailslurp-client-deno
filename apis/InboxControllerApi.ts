...
export class InboxControllerApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async createInbox(?: string, tagsThatInboxHasBeenTaggedWithTagsCanBeAddedToInboxesToGroupDifferentInboxesWithinAnAccountYouCanAlsoSearchForInboxesByTagInTheDashboardUI?: Array<string>, optionalNameOfTheInboxDisplayedInTheDashboardForEasierSearchAndUsedAsTheSenderNameWhenSendingEmails?: string, optionalDescriptionOfTheInboxForLabellingPurposesIsShownInTheDashboardAndCanBeUsedWith?: string, ?: boolean, isTheInboxAFavoriteMarkingAnInboxAsAFavoriteIsTypicallyDoneInTheDashboardForQuickAccessOrFiltering?: boolean, ?: Date, numberOfMillisecondsThatInboxShouldExistFor?: number, dEPRECATEDTeamAccessIsAlwaysTrueGrantTeamAccessToThisInboxAndTheEmailsThatBelongToItForTeamMembersOfYourOrganization?: boolean, ?: 'HTTP_INBOX' | 'SMTP_INBOX', options?: Configuration): Promise<RequestContext> {
        ...
        if ( !== undefined) {
            requestContext.setQueryParam("A custom email address to use with the inbox. Defaults to null. When null MailSlurp will assign a random email address to the inbox such as &#x60;123@mailslurp.com&#x60;. If you use the &#x60;useDomainPool&#x60; option when the email address is null it will generate an email address with a more varied domain ending such as &#x60;123@mailslurp.info&#x60; or &#x60;123@mailslurp.biz&#x60;. When a custom email address is provided the address is split into a domain and the domain is queried against your user. If you have created the domain in the MailSlurp dashboard and verified it you can use any email address that ends with the domain. Note domain types must match the inbox type - so &#x60;SMTP&#x60; inboxes will only work with &#x60;SMTP&#x60; type domains. Avoid &#x60;SMTP&#x60; inboxes if you need to send emails as they can only receive. Send an email to this address and the inbox will receive and store it for you. To retrieve the email use the Inbox and Email Controller endpoints with the inbox ID.", ObjectSerializer.serialize(, "string", ""));
        }
        if (tagsThatInboxHasBeenTaggedWithTagsCanBeAddedToInboxesToGroupDifferentInboxesWithinAnAccountYouCanAlsoSearchForInboxesByTagInTheDashboardUI !== undefined) {
            requestContext.setQueryParam("Tags that inbox has been tagged with. Tags can be added to inboxes to group different inboxes within an account. You can also search for inboxes by tag in the dashboard UI.", ObjectSerializer.serialize(tagsThatInboxHasBeenTaggedWithTagsCanBeAddedToInboxesToGroupDifferentInboxesWithinAnAccountYouCanAlsoSearchForInboxesByTagInTheDashboardUI, "Array<string>", ""));
        }
        if (optionalNameOfTheInboxDisplayedInTheDashboardForEasierSearchAndUsedAsTheSenderNameWhenSendingEmails !== undefined) {
            requestContext.setQueryParam("Optional name of the inbox. Displayed in the dashboard for easier search and used as the sender name when sending emails.", ObjectSerializer.serialize(optionalNameOfTheInboxDisplayedInTheDashboardForEasierSearchAndUsedAsTheSenderNameWhenSendingEmails, "string", ""));
        }
        if (optionalDescriptionOfTheInboxForLabellingPurposesIsShownInTheDashboardAndCanBeUsedWith !== undefined) {
            requestContext.setQueryParam("Optional description of the inbox for labelling purposes. Is shown in the dashboard and can be used with", ObjectSerializer.serialize(optionalDescriptionOfTheInboxForLabellingPurposesIsShownInTheDashboardAndCanBeUsedWith, "string", ""));
        }
        if ( !== undefined) {
            requestContext.setQueryParam("Use the MailSlurp domain name pool with this inbox when creating the email address. Defaults to null. If enabled the inbox will be an email address with a domain randomly chosen from a list of the MailSlurp domains. This is useful when the default &#x60;@mailslurp.com&#x60; email addresses used with inboxes are blocked or considered spam by a provider or receiving service. When domain pool is enabled an email address will be generated ending in &#x60;@mailslurp.{world,info,xyz,...}&#x60; . This means a TLD is randomly selecting from a list of &#x60;.biz&#x60;, &#x60;.info&#x60;, &#x60;.xyz&#x60; etc to add variance to the generated email addresses. When null or false MailSlurp uses the default behavior of &#x60;@mailslurp.com&#x60; or custom email address provided by the emailAddress field. Note this feature is only available for &#x60;HTTP&#x60; inbox types.", ObjectSerializer.serialize(, "boolean", ""));
        }
        if (isTheInboxAFavoriteMarkingAnInboxAsAFavoriteIsTypicallyDoneInTheDashboardForQuickAccessOrFiltering !== undefined) {
            requestContext.setQueryParam("Is the inbox a favorite. Marking an inbox as a favorite is typically done in the dashboard for quick access or filtering", ObjectSerializer.serialize(isTheInboxAFavoriteMarkingAnInboxAsAFavoriteIsTypicallyDoneInTheDashboardForQuickAccessOrFiltering, "boolean", ""));
        }
        if ( !== undefined) {
            requestContext.setQueryParam("Optional inbox expiration date. If null then this inbox is permanent and the emails in it won&#39;t be deleted. If an expiration date is provided or is required by your plan the inbox will be closed when the expiration time is reached. Expired inboxes still contain their emails but can no longer send or receive emails. An ExpiredInboxRecord is created when an inbox and the email address and inbox ID are recorded. The expiresAt property is a timestamp string in ISO DateTime Format yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSXXX.", ObjectSerializer.serialize(, "Date", "date-time"));
        }
        if (numberOfMillisecondsThatInboxShouldExistFor !== undefined) {
            requestContext.setQueryParam("Number of milliseconds that inbox should exist for", ObjectSerializer.serialize(numberOfMillisecondsThatInboxShouldExistFor, "number", "int64"));
        }
        if (dEPRECATEDTeamAccessIsAlwaysTrueGrantTeamAccessToThisInboxAndTheEmailsThatBelongToItForTeamMembersOfYourOrganization !== undefined) {
            requestContext.setQueryParam("DEPRECATED (team access is always true). Grant team access to this inbox and the emails that belong to it for team members of your organization.", ObjectSerializer.serialize(dEPRECATEDTeamAccessIsAlwaysTrueGrantTeamAccessToThisInboxAndTheEmailsThatBelongToItForTeamMembersOfYourOrganization, "boolean", ""));
        }
        if ( !== undefined) {
            requestContext.setQueryParam("HTTP (default) or SMTP inbox type. HTTP inboxes are default and best solution for most cases. SMTP inboxes are more reliable for public inbound email consumption (but do not support sending emails). When using custom domains the domain type must match the inbox type. HTTP inboxes are processed by AWS SES while SMTP inboxes use a custom mail server running at &#x60;mx.mailslurp.com&#x60;.", ObjectSerializer.serialize(, "'HTTP_INBOX' | 'SMTP_INBOX'", ""));
        }
     ...
     */
    public async getAllInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', favourite?: boolean, search?: string, tag?: string, dEPRECATEDOptionallyFilterByTeamAccess?: boolean, since?: Date, before?: Date, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
        ...
        if (dEPRECATEDOptionallyFilterByTeamAccess !== undefined) {
            requestContext.setQueryParam("DEPRECATED. Optionally filter by team access.", ObjectSerializer.serialize(dEPRECATEDOptionallyFilterByTeamAccess, "boolean", ""));
        }
        if (since !== undefined) {
     ...
     */
    public async getEmails(idOfInboxThatEmailsBelongsTo: string, aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit?: number, limit?: number, sortTheResultsByReceivedDateAndDirectionASCOrDESC?: 'ASC' | 'DESC', retryTimeout?: number, delayTimeout?: number, minCount?: number, unreadOnly?: boolean, excludeEmailsReceivedAfterThisISO8601DateTime?: Date, excludeEmailsReceivedBeforeThisISO8601DateTime?: Date, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'idOfInboxThatEmailsBelongsTo' is not null or undefined
        if (idOfInboxThatEmailsBelongsTo === null || idOfInboxThatEmailsBelongsTo === undefined) {
            throw new RequiredError('Required parameter idOfInboxThatEmailsBelongsTo was null or undefined when calling getEmails.');
        }
        ...
        const localVarPath = '/inboxes/{inboxId}/emails'
            .replace('{' + 'Id of inbox that emails belongs to' + '}', encodeURIComponent(String(idOfInboxThatEmailsBelongsTo)));
        ...
        // Query Params
        if (aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit !== undefined) {
            requestContext.setQueryParam("Alias for limit. Assessed first before assessing any passed limit.", ObjectSerializer.serialize(aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit, "number", "int32"));
        }
        if (limit !== undefined) {
            requestContext.setQueryParam("limit", ObjectSerializer.serialize(limit, "number", "int32"));
        }
        if (sortTheResultsByReceivedDateAndDirectionASCOrDESC !== undefined) {
            requestContext.setQueryParam("Sort the results by received date and direction ASC or DESC", ObjectSerializer.serialize(sortTheResultsByReceivedDateAndDirectionASCOrDESC, "'ASC' | 'DESC'", ""));
        }
        ...
        if (excludeEmailsReceivedAfterThisISO8601DateTime !== undefined) {
            requestContext.setQueryParam("Exclude emails received after this ISO 8601 date time", ObjectSerializer.serialize(excludeEmailsReceivedAfterThisISO8601DateTime, "Date", "date-time"));
        }
        if (excludeEmailsReceivedBeforeThisISO8601DateTime !== undefined) {
            requestContext.setQueryParam("Exclude emails received before this ISO 8601 date time", ObjectSerializer.serialize(excludeEmailsReceivedBeforeThisISO8601DateTime, "Date", "date-time"));
        }
     ...
     * @param idOfInboxThatEmailsBelongsTo 
     */
    public async getInboxEmailCount(idOfInboxThatEmailsBelongsTo: string, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'idOfInboxThatEmailsBelongsTo' is not null or undefined
        if (idOfInboxThatEmailsBelongsTo === null || idOfInboxThatEmailsBelongsTo === undefined) {
            throw new RequiredError('Required parameter idOfInboxThatEmailsBelongsTo was null or undefined when calling getInboxEmailCount.');
        }
     ...
     */
    public async getInboxEmailsPaginated(idOfInboxThatEmailsBelongsTo: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'idOfInboxThatEmailsBelongsTo' is not null or undefined
        if (idOfInboxThatEmailsBelongsTo === null || idOfInboxThatEmailsBelongsTo === undefined) {
            throw new RequiredError('Required parameter idOfInboxThatEmailsBelongsTo was null or undefined when calling getInboxEmailsPaginated.');
        }
     ...
     */
    public async getInboxSentEmails(inboxId: string, page?: number, optionalPageSizeInInboxSentEmailListPagination?: number, sort?: 'ASC' | 'DESC', searchFilter?: string, since?: Date, before?: Date, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
        ...
        if (optionalPageSizeInInboxSentEmailListPagination !== undefined) {
            requestContext.setQueryParam("Optional page size in inbox sent email list pagination", ObjectSerializer.serialize(optionalPageSizeInInboxSentEmailListPagination, "number", "int32"));
        }
        if (sort !== undefined) {
            requestContext.setQueryParam("sort", ObjectSerializer.serialize(sort, "'ASC' | 'DESC'", ""));
        }
     ...
     * @param before Optional filter by created before given date time
     */
    public async listInboxTrackingPixels(inboxId: string, page?: number, optionalPageSizeInInboxTrackingPixelListPagination?: number, sort?: 'ASC' | 'DESC', searchFilter?: string, since?: Date, before?: Date, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;
        ...
        if (optionalPageSizeInInboxTrackingPixelListPagination !== undefined) {
            requestContext.setQueryParam("Optional page size in inbox tracking pixel list pagination", ObjectSerializer.serialize(optionalPageSizeInInboxTrackingPixelListPagination, "number", "int32"));
        }
        if (sort !== undefined) {
            requestContext.setQueryParam("sort", ObjectSerializer.serialize(sort, "'ASC' | 'DESC'", ""));
        }
     ...
     */
    public async sendEmail(iDOfTheInboxYouWantToSendTheEmailFrom: string, sendEmailOptions: SendEmailOptions, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'iDOfTheInboxYouWantToSendTheEmailFrom' is not null or undefined
        if (iDOfTheInboxYouWantToSendTheEmailFrom === null || iDOfTheInboxYouWantToSendTheEmailFrom === undefined) {
            throw new RequiredError('Required parameter iDOfTheInboxYouWantToSendTheEmailFrom was null or undefined when calling sendEmail.');
        }
        ...
        // Path Params
        const localVarPath = '/inboxes/{inboxId}'
            .replace('{' + 'ID of the inbox you want to send the email from' + '}', encodeURIComponent(String(iDOfTheInboxYouWantToSendTheEmailFrom)));
     ...
     * @param sendEmailOptions 
     */
    public async sendEmailAndConfirm(iDOfTheInboxYouWantToSendTheEmailFrom: string, sendEmailOptions: SendEmailOptions, options?: Configuration): Promise<RequestContext> {
        let config = options || this.configuration;

        // verify required parameter 'iDOfTheInboxYouWantToSendTheEmailFrom' is not null or undefined
        if (iDOfTheInboxYouWantToSendTheEmailFrom === null || iDOfTheInboxYouWantToSendTheEmailFrom === undefined) {
            throw new RequiredError('Required parameter iDOfTheInboxYouWantToSendTheEmailFrom was null or undefined when calling sendEmailAndConfirm.');
        }
...
export class InboxControllerApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getInboxTags(response: ResponseContext): Promise<Set<string> > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
