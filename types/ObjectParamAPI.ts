...
export interface BounceControllerApiGetBouncedEmail1Request {
    /**
     * ID of the bounced recipient
     * @type string
     * @memberof BounceControllerApigetBouncedEmail1
     */
    id: string
}
...
export class ObjectBounceControllerApi {
     ...
     * @param param the request object
     */
    public getBouncedEmail(param: BounceControllerApiGetBouncedEmailRequest, options?: Configuration): Promise<void | Bounce> {
     ...
     * @param param the request object
     */
    public getBouncedEmail1(param: BounceControllerApiGetBouncedEmail1Request, options?: Configuration): Promise<BounceRecipient | void> {
        return this.api.getBouncedEmail1(param.id,  options).toPromise();
    }
     ...
     * @param param the request object
     */
    public getBouncedEmails(param: BounceControllerApiGetBouncedEmailsRequest, options?: Configuration): Promise<void | PageBouncedEmail> {
     ...
     * @param param the request object
     */
    public getBouncedRecipients(param: BounceControllerApiGetBouncedRecipientsRequest, options?: Configuration): Promise<void | PageBouncedRecipients> {
