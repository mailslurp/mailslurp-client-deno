...
export class ObjectAttachmentControllerApi {
    ...
    public getAttachments(param: AttachmentControllerApiGetAttachmentsRequest, options?: Configuration): Promise<PageAttachmentEntity> {
        return this.api.getAttachments(param.page, param.size, param.sort, param.fileNameFilter, param.since, param.before, param.inboxId, param.emailId, param.sentEmailId,  options).toPromise();
    }
    ...
    public uploadMultipartForm(param: AttachmentControllerApiUploadMultipartFormRequest, options?: Configuration): Promise<Array<string>> {
        return this.api.uploadMultipartForm(param.contentId, param.contentType, param.filename, param.contentTypeHeader, param.xFilename, param.xFilenameRaw, param.xFilesize, param.inlineObject,  options).toPromise();
    }
...
export class ObjectEmailControllerApi {
    ...
    public getEmailsOffsetPaginated(param: EmailControllerApiGetEmailsOffsetPaginatedRequest, options?: Configuration): Promise<PageEmailProjection> {
        return this.api.getEmailsOffsetPaginated(param.inboxId, param.page, param.size, param.sort, param.unreadOnly, param.searchFilter, param.since, param.before, param.favourited, param.syncConnectors, param.plusAddressId,  options).toPromise();
    }
...
export interface InboxRulesetControllerApiTestInboxRulesetReceivingRequest {
    /**
     * 
     * @type TestInboxRulesetReceivingOptions
     * @memberof InboxRulesetControllerApitestInboxRulesetReceiving
     */
    testInboxRulesetReceivingOptions: TestInboxRulesetReceivingOptions
}

export interface InboxRulesetControllerApiTestInboxRulesetSendingRequest {
    /**
     * 
     * @type TestInboxRulesetSendingOptions
     * @memberof InboxRulesetControllerApitestInboxRulesetSending
     */
...
export class ObjectInboxRulesetControllerApi {
     ...
     * @param param the request object
     */
    public testInboxRulesetReceiving(param: InboxRulesetControllerApiTestInboxRulesetReceivingRequest, options?: Configuration): Promise<TestInboxRulesetReceivingResult> {
        return this.api.testInboxRulesetReceiving(param.testInboxRulesetReceivingOptions,  options).toPromise();
    }
     ...
     * @param param the request object
     */
    public testInboxRulesetSending(param: InboxRulesetControllerApiTestInboxRulesetSendingRequest, options?: Configuration): Promise<TestInboxRulesetSendingResult> {
        return this.api.testInboxRulesetSending(param.testInboxRulesetSendingOptions,  options).toPromise();
    }
...
export class ObjectPhoneControllerApi {
    ...
    public getPhoneNumberByName(param: PhoneControllerApiGetPhoneNumberByNameRequest, options?: Configuration): Promise<PhoneNumberDto> {
        return this.api.getPhoneNumberByName( options).toPromise();
    }
    ...
    public getPhoneNumberByPhoneNumber(param: PhoneControllerApiGetPhoneNumberByPhoneNumberRequest, options?: Configuration): Promise<PhoneNumberDto> {
        return this.api.getPhoneNumberByPhoneNumber( options).toPromise();
    }
...
export class ObjectSmsControllerApi {
    ...
    public getAllSmsMessages(param: SmsControllerApiGetAllSmsMessagesRequest, options?: Configuration): Promise<PageSmsProjection> {
        return this.api.getAllSmsMessages(param.phoneNumber, param.page, param.size, param.sort, param.since, param.before, param.search, param.favourite,  options).toPromise();
    }
...
export interface SseControllerApiStreamEventsRequest {
    /**
     * 
     * @type string
     * @memberof SseControllerApistreamEvents
     */
    xApiKey: string
}

export class ObjectSseControllerApi {
    private api: ObservableSseControllerApi

    public constructor(configuration: Configuration, requestFactory?: SseControllerApiRequestFactory, responseProcessor?: SseControllerApiResponseProcessor) {
     ...
     * @param param the request object
     */
    public streamEvents(param: SseControllerApiStreamEventsRequest, options?: Configuration): Promise<Array<string>> {
        return this.api.streamEvents(param.xApiKey,  options).toPromise();
    }
...
export interface WebhookControllerApiGetAllAccountWebhooksRequest {
    ...
    /**
     * Optional event type
     * @type &#39;EMAIL_RECEIVED&#39; | &#39;NEW_EMAIL&#39; | &#39;NEW_CONTACT&#39; | &#39;NEW_ATTACHMENT&#39; | &#39;EMAIL_OPENED&#39; | &#39;EMAIL_READ&#39; | &#39;DELIVERY_STATUS&#39; | &#39;BOUNCE&#39; | &#39;BOUNCE_RECIPIENT&#39; | &#39;NEW_SMS&#39; | &#39;NEW_GUEST_USER&#39;
     * @memberof WebhookControllerApigetAllAccountWebhooks
     */
    eventType?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'DELIVERY_STATUS' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS' | 'NEW_GUEST_USER'
    /**
...
export interface WebhookControllerApiGetAllWebhookResultsRequest {
     ...
     * @memberof WebhookControllerApigetAllWebhookResults
     */
    eventName?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'DELIVERY_STATUS' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS' | 'NEW_GUEST_USER'
    /**
...
export interface WebhookControllerApiGetJsonSchemaForWebhookEventRequest {
     ...
     */
    event: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'DELIVERY_STATUS' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS' | 'NEW_GUEST_USER'
}
...
export class ObjectWebhookControllerApi {
    ...
    public getAllWebhookResults(param: WebhookControllerApiGetAllWebhookResultsRequest, options?: Configuration): Promise<PageWebhookResult> {
        return this.api.getAllWebhookResults(param.page, param.size, param.sort, param.searchFilter, param.since, param.before, param.unseenOnly, param.resultType, param.eventName, param.minStatusCode, param.maxStatusCode, param.inboxId, param.smsId, param.attachmentId, param.emailId, param.phoneId,  options).toPromise();
    }
    ...
    public getAllWebhooks(param: WebhookControllerApiGetAllWebhooksRequest, options?: Configuration): Promise<PageWebhookProjection> {
        return this.api.getAllWebhooks(param.page, param.size, param.sort, param.searchFilter, param.since, param.inboxId, param.phoneId, param.before, param.health, param.eventType, param.url,  options).toPromise();
    }
    ...
    public updateWebhook(param: WebhookControllerApiUpdateWebhookRequest, options?: Configuration): Promise<WebhookDto> {
        return this.api.updateWebhook(param.webhookId, param.createWebhookOptions, param.inboxId, param.phoneNumberId, param.overrideAuth,  options).toPromise();
    }
