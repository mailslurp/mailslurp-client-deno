...
export class ObjectInboxControllerApi {
    ...
    public createInbox(param: InboxControllerApiCreateInboxRequest, options?: Configuration): Promise<Inbox> {
        return this.api.createInbox(param.allowTeamAccess, param.description, param.emailAddress, param.expiresAt, param.expiresIn, param.favourite, param.name, param.tags, param.useDomainPool,  options).toPromise();
    }
...
export class ObjectWebhookControllerApi {
     ...
     * @param param the request object
     */
    public getTestWebhookPayload(param: WebhookControllerApiGetTestWebhookPayloadRequest, options?: Configuration): Promise<WebhookPayload> {
        return this.api.getTestWebhookPayload( options).toPromise();
    }
