...
export class ObjectAIControllerApi {
     ...
     */
    public generateStructuredContentFromAttachment(param: AIControllerApiGenerateStructuredContentFromAttachmentRequest, options?: Configuration): Promise<StructuredContentResult> {
     ...
     * @param param the request object
     */
    public generateStructuredContentFromEmail(param: AIControllerApiGenerateStructuredContentFromEmailRequest, options?: Configuration): Promise<StructuredContentResult> {
