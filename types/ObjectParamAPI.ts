...
export class ObjectWaitForControllerApi {
    ...
    public waitForMatchingEmail(param: WaitForControllerApiWaitForMatchingEmailRequest, options?: Configuration): Promise<Array<EmailPreview> | void> {
        return this.api.waitForMatchingEmail(param.matchOptions, param.count, param.delay, param.inboxId, param.since, param.sort, param.timeout, param.unreadOnly,  options).toPromise();
    }
...
export interface WebhookControllerApiGetTestWebhookPayloadRequest {
    /**
     * eventName
     * @type &#39;EMAIL_RECEIVED&#39; | &#39;NEW_EMAIL&#39; | &#39;NEW_CONTACT&#39; | &#39;NEW_ATTACHMENT&#39; | &#39;EMAIL_OPENED&#39;
...
export class ObjectWebhookControllerApi {
     ...
     * @param param the request object
     */
    public getWebhookResult(param: WebhookControllerApiGetWebhookResultRequest, options?: Configuration): Promise<WebhookResultEntity> {
