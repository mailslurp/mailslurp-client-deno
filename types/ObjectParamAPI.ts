...
export interface ApiInternalControllerApiGetSamlUserOrCreateRequest {
    /**
     * 
     * @type string
     * @memberof ApiInternalControllerApigetSamlUserOrCreate
     */
    key: string
    /**
     * 
     * @type GetOrCreateSamlUserOptions
     * @memberof ApiInternalControllerApigetSamlUserOrCreate
     */
    getOrCreateSamlUserOptions: GetOrCreateSamlUserOptions
}

export class ObjectApiInternalControllerApi {
    private api: ObservableApiInternalControllerApi

    public constructor(configuration: Configuration, requestFactory?: ApiInternalControllerApiRequestFactory, responseProcessor?: ApiInternalControllerApiResponseProcessor) {
     ...
     * @param param the request object
     */
    public getSamlUserOrCreate(param: ApiInternalControllerApiGetSamlUserOrCreateRequest, options?: Configuration): Promise<UserDto> {
        return this.api.getSamlUserOrCreate(param.key, param.getOrCreateSamlUserOptions,  options).toPromise();
    }
