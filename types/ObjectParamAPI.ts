...
export interface ApiUserControllerApiGetSmtpPasswordRequest {
}

export interface ApiUserControllerApiGetSmtpUsernameRequest {
}

export interface ApiUserControllerApiGetUserInfoRequest {
}

export class ObjectApiUserControllerApi {
    private api: ObservableApiUserControllerApi

    public constructor(configuration: Configuration, requestFactory?: ApiUserControllerApiRequestFactory, responseProcessor?: ApiUserControllerApiResponseProcessor) {
     ...
     * @param param the request object
     */
    public getSmtpPassword(param: ApiUserControllerApiGetSmtpPasswordRequest, options?: Configuration): Promise<string> {
        return this.api.getSmtpPassword( options).toPromise();
    }

    /**
     * @param param the request object
     */
    public getSmtpUsername(param: ApiUserControllerApiGetSmtpUsernameRequest, options?: Configuration): Promise<string> {
        return this.api.getSmtpUsername( options).toPromise();
    }

    /**
     * @param param the request object
     */
    public getUserInfo(param: ApiUserControllerApiGetUserInfoRequest, options?: Configuration): Promise<UserInfoDto> {
...
export class ObjectCommonActionsControllerApi {
    ...
    public createNewEmailAddress(param: CommonActionsControllerApiCreateNewEmailAddressRequest, options?: Configuration): Promise<InboxDto> {
        return this.api.createNewEmailAddress(param.allowTeamAccess, param.useDomainPool, param.expiresAt, param.expiresIn, param.emailAddress, param.inboxType, param.description, param.name, param.tags, param.favourite, param.virtualInbox,  options).toPromise();
    }
    ...
    public createRandomInbox(param: CommonActionsControllerApiCreateRandomInboxRequest, options?: Configuration): Promise<InboxDto> {
        return this.api.createRandomInbox(param.allowTeamAccess, param.useDomainPool, param.expiresAt, param.expiresIn, param.emailAddress, param.inboxType, param.description, param.name, param.tags, param.favourite, param.virtualInbox,  options).toPromise();
    }
...
export class ObjectEmailControllerApi {
    ...
    public sendEmailSourceOptional(param: EmailControllerApiSendEmailSourceOptionalRequest, options?: Configuration): Promise<void> {
        return this.api.sendEmailSourceOptional(param.inboxId, param.sendEmailOptions, param.useDomainPool, param.virtualSend,  options).toPromise();
    }
...
export class ObjectInboxControllerApi {
    ...
    public createInbox(param: InboxControllerApiCreateInboxRequest, options?: Configuration): Promise<InboxDto> {
        return this.api.createInbox(param.emailAddress, param.tags, param.name, param.description, param.useDomainPool, param.favourite, param.expiresAt, param.expiresIn, param.allowTeamAccess, param.inboxType, param.virtualInbox,  options).toPromise();
    }
...
export class ObjectPhoneControllerApi {
    ...
    public getPhoneNumbers(param: PhoneControllerApiGetPhoneNumbersRequest, options?: Configuration): Promise<PagePhoneNumberProjection> {
        return this.api.getPhoneNumbers(param.page, param.size, param.sort, param.since, param.before,  options).toPromise();
    }
...
export class ObjectSentEmailsControllerApi {
     ...
     * @param param the request object
     */
    public getSentDeliveryStatus(param: SentEmailsControllerApiGetSentDeliveryStatusRequest, options?: Configuration): Promise<DeliveryStatus> {
...
export class ObjectSmsControllerApi {
     ...
     * @param param the request object
     */
    public getSmsMessage(param: SmsControllerApiGetSmsMessageRequest, options?: Configuration): Promise<SmsMessage> {
...
export interface WebhookControllerApiGetJsonSchemaForWebhookEventRequest {
    /**
     * 
     * @type &#39;EMAIL_RECEIVED&#39; | &#39;NEW_EMAIL&#39; | &#39;NEW_CONTACT&#39; | &#39;NEW_ATTACHMENT&#39; | &#39;EMAIL_OPENED&#39; | &#39;EMAIL_READ&#39; | &#39;BOUNCE&#39; | &#39;BOUNCE_RECIPIENT&#39; | &#39;NEW_SMS&#39;
     * @memberof WebhookControllerApigetJsonSchemaForWebhookEvent
     */
    event: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS'
}
