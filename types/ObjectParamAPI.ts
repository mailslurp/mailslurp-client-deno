...
export class ObjectInboxControllerApi {
    ...
    public getEmails(param: InboxControllerApiGetEmailsRequest, options?: Configuration): Promise<Array<EmailPreview>> {
        return this.api.getEmails(param.inboxId, param.aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit, param.limit, param.sortTheResultsByReceivedDateAndDirectionASCOrDESC, param.retryTimeout, param.delayTimeout, param.minCount, param.unreadOnly, param.before, param.since,  options).toPromise();
    }
