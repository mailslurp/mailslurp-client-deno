...
export interface AttachmentControllerApiGetAttachments1Request {
    /**
     * Optional page index event list pagination
     * @type number
     * @memberof AttachmentControllerApigetAttachments1
     */
    page?: number
    /**
...
export class ObjectAttachmentControllerApi {
     ...
     * @param param the request object
     */
    public downloadAttachmentAsBytes(param: AttachmentControllerApiDownloadAttachmentAsBytesRequest, options?: Configuration): Promise<Array<string>> {
     ...
     * @param param the request object
     */
    public getAttachments1(param: AttachmentControllerApiGetAttachments1Request, options?: Configuration): Promise<PageAttachmentEntity> {
        return this.api.getAttachments1(param.page, param.size, param.sort, param.fileNameFilter, param.since, param.before,  options).toPromise();
    }
...
export class ObjectCommonActionsControllerApi {
     ...
     * @param param the request object
     */
    public createNewEmailAddress1(param: CommonActionsControllerApiCreateNewEmailAddress1Request, options?: Configuration): Promise<InboxDto> {
        return this.api.createNewEmailAddress1(param.allowTeamAccess, param.useDomainPool, param.expiresAt, param.expiresIn, param.emailAddress, param.inboxType, param.description, param.name, param.tags, param.favourite,  options).toPromise();
    }
...
export interface EmailControllerApiGetAttachmentsRequest {
    /**
     * ID of email
     * @type string
     * @memberof EmailControllerApigetAttachments
     */
    emailId: string
}
...
export class ObjectEmailControllerApi {
     ...
     * @param param the request object
     */
    public downloadAttachment(param: EmailControllerApiDownloadAttachmentRequest, options?: Configuration): Promise<Array<string>> {
     ...
     * @param param the request object
     */
    public downloadBodyBytes(param: EmailControllerApiDownloadBodyBytesRequest, options?: Configuration): Promise<Array<string>> {
     ...
     * @param param the request object
     */
    public getAttachments(param: EmailControllerApiGetAttachmentsRequest, options?: Configuration): Promise<Array<AttachmentMetaData>> {
        return this.api.getAttachments(param.emailId,  options).toPromise();
    }
    ...
    public sendEmailSourceOptional(param: EmailControllerApiSendEmailSourceOptionalRequest, options?: Configuration): Promise<void> {
        return this.api.sendEmailSourceOptional(param.sendEmailOptions, param.inboxId, param.useDomainPool,  options).toPromise();
    }
...
export class ObjectExpiredControllerApi {
    ...
    public getExpiredInboxRecord(param: ExpiredControllerApiGetExpiredInboxRecordRequest, options?: Configuration): Promise<ExpiredInboxDto> {
        return this.api.getExpiredInboxRecord(param.iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId,  options).toPromise();
    }
...
export interface InboxControllerApiCreateInboxRequest {
     ...
     * @memberof InboxControllerApicreateInbox
     */
    tagsThatInboxHasBeenTaggedWithTagsCanBeAddedToInboxesToGroupDifferentInboxesWithinAnAccountYouCanAlsoSearchForInboxesByTagInTheDashboardUI?: Array<string>
    /**
     * 
     * @type string
     * @memberof InboxControllerApicreateInbox
     */
    optionalNameOfTheInboxDisplayedInTheDashboardForEasierSearchAndUsedAsTheSenderNameWhenSendingEmails?: string
    /**
     * 
     * @type string
     * @memberof InboxControllerApicreateInbox
     */
    optionalDescriptionOfTheInboxForLabellingPurposesIsShownInTheDashboardAndCanBeUsedWith?: string
    /**
     * 
     * @type boolean
     * @memberof InboxControllerApicreateInbox
     ...
     * @memberof InboxControllerApicreateInbox
     */
    isTheInboxAFavoriteMarkingAnInboxAsAFavoriteIsTypicallyDoneInTheDashboardForQuickAccessOrFiltering?: boolean
    /**
     * 
     * @type Date
     * @memberof InboxControllerApicreateInbox
     ...
     * @memberof InboxControllerApicreateInbox
     */
    numberOfMillisecondsThatInboxShouldExistFor?: number
    /**
     * 
     * @type boolean
     * @memberof InboxControllerApicreateInbox
     */
    dEPRECATEDTeamAccessIsAlwaysTrueGrantTeamAccessToThisInboxAndTheEmailsThatBelongToItForTeamMembersOfYourOrganization?: boolean
    /**
     * 
     * @type &#39;HTTP_INBOX&#39; | &#39;SMTP_INBOX&#39;
     * @memberof InboxControllerApicreateInbox
...
export interface InboxControllerApiGetAllInboxesRequest {
     ...
     * @memberof InboxControllerApigetAllInboxes
     */
    dEPRECATEDOptionallyFilterByTeamAccess?: boolean
    /**
...
export interface InboxControllerApiGetEmailsRequest {
     ...
     * @memberof InboxControllerApigetEmails
     */
    aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit?: number
    /**
     ...
     * @memberof InboxControllerApigetEmails
     */
    sortTheResultsByReceivedDateAndDirectionASCOrDESC?: 'ASC' | 'DESC'
    /**
     ...
     * @memberof InboxControllerApigetEmails
     */
    excludeEmailsReceivedAfterThisISO8601DateTime?: Date
    /**
     * 
     * @type Date
     * @memberof InboxControllerApigetEmails
     */
    excludeEmailsReceivedBeforeThisISO8601DateTime?: Date
}
...
export interface InboxControllerApiGetInboxSentEmailsRequest {
     ...
     * @memberof InboxControllerApigetInboxSentEmails
     */
    optionalPageSizeInInboxSentEmailListPagination?: number
    /**
     * Optional createdAt sort direction ASC or DESC
     * @type &#39;ASC&#39; | &#39;DESC&#39;
     * @memberof InboxControllerApigetInboxSentEmails
...
export interface InboxControllerApiListInboxTrackingPixelsRequest {
     ...
     * @memberof InboxControllerApilistInboxTrackingPixels
     */
    optionalPageSizeInInboxTrackingPixelListPagination?: number
    /**
     * Optional createdAt sort direction ASC or DESC
     * @type &#39;ASC&#39; | &#39;DESC&#39;
     * @memberof InboxControllerApilistInboxTrackingPixels
...
export class ObjectInboxControllerApi {
    ...
    public createInbox(param: InboxControllerApiCreateInboxRequest, options?: Configuration): Promise<InboxDto> {
        return this.api.createInbox(param., param.tagsThatInboxHasBeenTaggedWithTagsCanBeAddedToInboxesToGroupDifferentInboxesWithinAnAccountYouCanAlsoSearchForInboxesByTagInTheDashboardUI, param.optionalNameOfTheInboxDisplayedInTheDashboardForEasierSearchAndUsedAsTheSenderNameWhenSendingEmails, param.optionalDescriptionOfTheInboxForLabellingPurposesIsShownInTheDashboardAndCanBeUsedWith, param., param.isTheInboxAFavoriteMarkingAnInboxAsAFavoriteIsTypicallyDoneInTheDashboardForQuickAccessOrFiltering, param., param.numberOfMillisecondsThatInboxShouldExistFor, param.dEPRECATEDTeamAccessIsAlwaysTrueGrantTeamAccessToThisInboxAndTheEmailsThatBelongToItForTeamMembersOfYourOrganization, param.,  options).toPromise();
    }
    ...
    public getAllInboxes(param: InboxControllerApiGetAllInboxesRequest, options?: Configuration): Promise<PageInboxProjection> {
        return this.api.getAllInboxes(param.page, param.size, param.sort, param.favourite, param.search, param.tag, param.dEPRECATEDOptionallyFilterByTeamAccess, param.since, param.before,  options).toPromise();
    }
    ...
    public getEmails(param: InboxControllerApiGetEmailsRequest, options?: Configuration): Promise<Array<EmailPreview>> {
        return this.api.getEmails(param.idOfInboxThatEmailsBelongsTo, param.aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit, param.limit, param.sortTheResultsByReceivedDateAndDirectionASCOrDESC, param.retryTimeout, param.delayTimeout, param.minCount, param.unreadOnly, param.excludeEmailsReceivedAfterThisISO8601DateTime, param.excludeEmailsReceivedBeforeThisISO8601DateTime,  options).toPromise();
    }
    ...
    public getInboxEmailCount(param: InboxControllerApiGetInboxEmailCountRequest, options?: Configuration): Promise<CountDto> {
        return this.api.getInboxEmailCount(param.idOfInboxThatEmailsBelongsTo,  options).toPromise();
    }
    ...
    public getInboxEmailsPaginated(param: InboxControllerApiGetInboxEmailsPaginatedRequest, options?: Configuration): Promise<PageEmailPreview> {
        return this.api.getInboxEmailsPaginated(param.idOfInboxThatEmailsBelongsTo, param.page, param.size, param.sort, param.since, param.before,  options).toPromise();
    }
    ...
    public getInboxSentEmails(param: InboxControllerApiGetInboxSentEmailsRequest, options?: Configuration): Promise<PageSentEmailProjection> {
        return this.api.getInboxSentEmails(param.inboxId, param.page, param.optionalPageSizeInInboxSentEmailListPagination, param.sort, param.searchFilter, param.since, param.before,  options).toPromise();
    }
     ...
     * @param param the request object
     */
    public getInboxTags(param: InboxControllerApiGetInboxTagsRequest, options?: Configuration): Promise<Set<string>> {
    ...
    public listInboxTrackingPixels(param: InboxControllerApiListInboxTrackingPixelsRequest, options?: Configuration): Promise<PageTrackingPixelProjection> {
        return this.api.listInboxTrackingPixels(param.inboxId, param.page, param.optionalPageSizeInInboxTrackingPixelListPagination, param.sort, param.searchFilter, param.since, param.before,  options).toPromise();
    }
    ...
    public sendEmail(param: InboxControllerApiSendEmailRequest, options?: Configuration): Promise<void> {
        return this.api.sendEmail(param.iDOfTheInboxYouWantToSendTheEmailFrom, param.sendEmailOptions,  options).toPromise();
    }
    ...
    public sendEmailAndConfirm(param: InboxControllerApiSendEmailAndConfirmRequest, options?: Configuration): Promise<SentEmailDto> {
        return this.api.sendEmailAndConfirm(param.iDOfTheInboxYouWantToSendTheEmailFrom, param.sendEmailOptions,  options).toPromise();
    }
