...
export class ObjectInboxControllerApi {
    ...
    public listInboxRulesets(param: InboxControllerApiListInboxRulesetsRequest, options?: Configuration): Promise<void> {
        return this.api.listInboxRulesets(param.inboxId, param.page, param.size, param.sort,  options).toPromise();
    }
...
export class ObjectInboxRulesetControllerApi {
     ...
     * @param param the request object
     */
    public getInboxRulesets(param: InboxRulesetControllerApiGetInboxRulesetsRequest, options?: Configuration): Promise<PageInboxRulesetProjection> {
        return this.api.getInboxRulesets(param.inboxId, param.page, param.size, param.sort,  options).toPromise();
    }
...
export class ObjectMissedEmailControllerApi {
    ...
    public getAllMissedEmails(param: MissedEmailControllerApiGetAllMissedEmailsRequest, options?: Configuration): Promise<PageMissedEmailProjection> {
        return this.api.getAllMissedEmails(param.page, param.searchFilter, param.size, param.sort,  options).toPromise();
    }
