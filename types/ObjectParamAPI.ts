...
export interface AIControllerApiCreateTransformer1Request {
    /**
     * 
     * @type AITranformCreateOptions
     * @memberof AIControllerApicreateTransformer1
     */
...
export class ObjectAIControllerApi {
     ...
     */
    public createTransformer(param: AIControllerApiCreateTransformerRequest, options?: Configuration): Promise<PageAITransformProjection> {
        return this.api.createTransformer(param.options, param.page, param.size, param.sort,  options).toPromise();
    }
     ...
     * @param param the request object
     */
    public createTransformer1(param: AIControllerApiCreateTransformer1Request, options?: Configuration): Promise<AITransformDto> {
        return this.api.createTransformer1(param.aITranformCreateOptions,  options).toPromise();
    }
...
export class ObjectMFAControllerApi {
    ...
    public createTotpDeviceForCustom(param: MFAControllerApiCreateTotpDeviceForCustomRequest, options?: Configuration): Promise<TotpDeviceDto> {
        return this.api.createTotpDeviceForCustom(param.createTotpDeviceOtpAuthUrlOptions,  options).toPromise();
    }
    ...
    public getTotpDeviceCode(param: MFAControllerApiGetTotpDeviceCodeRequest, options?: Configuration): Promise<TotpDeviceCodeDto> {
        return this.api.getTotpDeviceCode(param.id, param.at,  options).toPromise();
    }
