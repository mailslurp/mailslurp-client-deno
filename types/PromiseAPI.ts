...
import { ObservableApiUserControllerApi } from './ObservableAPI.ts';

import { ApiUserControllerApiRequestFactory, ApiUserControllerApiResponseProcessor} from "../apis/ApiUserControllerApi.ts";
export class PromiseApiUserControllerApi {
    private api: ObservableApiUserControllerApi

    public constructor(
        configuration: Configuration,
        requestFactory?: ApiUserControllerApiRequestFactory,
        responseProcessor?: ApiUserControllerApiResponseProcessor
    ) {
        this.api = new ObservableApiUserControllerApi(configuration, requestFactory, responseProcessor);
    }

    /**
     */
    public getSmtpPassword(options?: Configuration): Promise<string> {
        const result = this.api.getSmtpPassword(options);
        return result.toPromise();
    }

    /**
     */
    public getSmtpUsername(options?: Configuration): Promise<string> {
        const result = this.api.getSmtpUsername(options);
        return result.toPromise();
    }
...
export class PromiseAttachmentControllerApi {
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getAttachments(page?: number, size?: number, sort?: 'ASC' | 'DESC', fileNameFilter?: string, since?: Date, before?: Date, options?: Configuration): Promise<PageAttachmentEntity> {
        const result = this.api.getAttachments(page, size, sort, fileNameFilter, since, before, options);
        return result.toPromise();
    }
     ...
     */
    public uploadAttachmentBytes(inlineObject1: InlineObject1, contentType?: string, filename?: string, options?: Configuration): Promise<Array<string>> {
        const result = this.api.uploadAttachmentBytes(inlineObject1, contentType, filename, options);
        return result.toPromise();
    }
...
export class PromiseCommonActionsControllerApi {
     ...
     * @param virtualInbox 
     */
    public createNewEmailAddress(allowTeamAccess?: boolean, useDomainPool?: boolean, expiresAt?: Date, expiresIn?: number, emailAddress?: string, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', description?: string, name?: string, tags?: Array<string>, favourite?: boolean, virtualInbox?: boolean, options?: Configuration): Promise<InboxDto> {
        const result = this.api.createNewEmailAddress(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, options);
        return result.toPromise();
    }
     ...
     * @param virtualInbox 
     */
    public createRandomInbox(allowTeamAccess?: boolean, useDomainPool?: boolean, expiresAt?: Date, expiresIn?: number, emailAddress?: string, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', description?: string, name?: string, tags?: Array<string>, favourite?: boolean, virtualInbox?: boolean, options?: Configuration): Promise<InboxDto> {
        const result = this.api.createRandomInbox(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, options);
        return result.toPromise();
    }
...
export class PromiseEmailControllerApi {
     ...
     * @param decode 
     */
    public getEmailHTMLJson(emailId: string, decode?: boolean, options?: Configuration): Promise<EmailHtmlDto> {
        const result = this.api.getEmailHTMLJson(emailId, decode, options);
        return result.toPromise();
    }
     ...
     */
    public sendEmailSourceOptional(inboxId: string, sendEmailOptions: SendEmailOptions, useDomainPool?: boolean, virtualSend?: boolean, options?: Configuration): Promise<void> {
        const result = this.api.sendEmailSourceOptional(inboxId, sendEmailOptions, useDomainPool, virtualSend, options);
        return result.toPromise();
    }
...
export class PromiseInboxControllerApi {
     ...
     */
    public createInbox(emailAddress?: string, tags?: Array<string>, name?: string, description?: string, useDomainPool?: boolean, favourite?: boolean, expiresAt?: Date, expiresIn?: number, allowTeamAccess?: boolean, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', virtualInbox?: boolean, options?: Configuration): Promise<InboxDto> {
        const result = this.api.createInbox(emailAddress, tags, name, description, useDomainPool, favourite, expiresAt, expiresIn, allowTeamAccess, inboxType, virtualInbox, options);
        return result.toPromise();
    }
     ...
     */
    public getAllInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', favourite?: boolean, search?: string, tag?: string, teamAccess?: boolean, since?: Date, before?: Date, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', domainId?: string, options?: Configuration): Promise<PageInboxProjection> {
        const result = this.api.getAllInboxes(page, size, sort, favourite, search, tag, teamAccess, since, before, inboxType, domainId, options);
        return result.toPromise();
    }
...
export class PromisePhoneControllerApi {
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getPhoneNumbers(page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Promise<PagePhoneNumberProjection> {
        const result = this.api.getPhoneNumbers(page, size, sort, since, before, options);
        return result.toPromise();
    }
     ...
     */
    public testPhoneNumberSendSms(phoneNumberId: string, testPhoneNumberOptions: TestPhoneNumberOptions, options?: Configuration): Promise<void> {
        const result = this.api.testPhoneNumberSendSms(phoneNumberId, testPhoneNumberOptions, options);
        return result.toPromise();
    }
...
export class PromiseSentEmailsControllerApi {
     ...
     * @param emailId ID of email
     */
    public getRawSentEmailContents(emailId: string, options?: Configuration): Promise<string> {
...
export class PromiseWebhookControllerApi {
     ...
     * @param event 
     */
    public getJsonSchemaForWebhookEvent(event: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS', options?: Configuration): Promise<JSONSchemaDto> {
     ...
     * @param eventName 
     */
    public getTestWebhookPayload(eventName?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS', options?: Configuration): Promise<AbstractWebhookPayload> {
