...
export class PromiseAliasControllerApi {
     ...
     */
    public getAliases(page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Promise<PageAlias> {
        const result = this.api.getAliases(page, size, sort, since, before, options);
        return result.toPromise();
    }
...
export class PromiseAttachmentControllerApi {
     ...
     * @param attachmentId ID of attachment
     */
    public downloadAttachmentAsBytes(attachmentId: string, options?: Configuration): Promise<Array<string>> {
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getAttachments1(page?: number, size?: number, sort?: 'ASC' | 'DESC', fileNameFilter?: string, since?: Date, before?: Date, options?: Configuration): Promise<PageAttachmentEntity> {
        const result = this.api.getAttachments1(page, size, sort, fileNameFilter, since, before, options);
        return result.toPromise();
    }
     ...
     */
    public uploadAttachmentBytes(requestBody: Array<string>, contentType?: string, filename?: string, options?: Configuration): Promise<Array<string>> {
        const result = this.api.uploadAttachmentBytes(requestBody, contentType, filename, options);
        return result.toPromise();
    }
     ...
     * @param inlineObject 
     */
    public uploadMultipartForm(contentType?: string, filename?: string, xFilename?: string, inlineObject?: InlineObject, options?: Configuration): Promise<Array<string>> {
        const result = this.api.uploadMultipartForm(contentType, filename, xFilename, inlineObject, options);
        return result.toPromise();
    }
...
export class PromiseCommonActionsControllerApi {
     ...
     * @param favourite 
     */
    public createNewEmailAddress(allowTeamAccess?: boolean, useDomainPool?: boolean, expiresAt?: Date, expiresIn?: number, emailAddress?: string, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', description?: string, name?: string, tags?: Set<string>, favourite?: boolean, options?: Configuration): Promise<InboxDto> {
        const result = this.api.createNewEmailAddress(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, options);
        return result.toPromise();
    }
     ...
     * @param favourite 
     */
    public createNewEmailAddress1(allowTeamAccess?: boolean, useDomainPool?: boolean, expiresAt?: Date, expiresIn?: number, emailAddress?: string, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', description?: string, name?: string, tags?: Set<string>, favourite?: boolean, options?: Configuration): Promise<InboxDto> {
        const result = this.api.createNewEmailAddress1(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, options);
        return result.toPromise();
    }
...
export class PromiseContactControllerApi {
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getAllContacts(page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Promise<PageContactProjection> {
        const result = this.api.getAllContacts(page, size, sort, since, before, options);
        return result.toPromise();
    }
     ...
     * @param contactId 
     */
    public getContactVCard(contactId: string, options?: Configuration): Promise<Array<string>> {
...
export class PromiseEmailControllerApi {
     ...
     */
    public downloadAttachment(emailId: string, attachmentId: string, apiKey?: string, options?: Configuration): Promise<Array<string>> {
     ...
     * @param emailId ID of email
     */
    public downloadBodyBytes(emailId: string, options?: Configuration): Promise<Array<string>> {
     ...
     */
    public getLatestEmail(inboxIds?: Set<string>, options?: Configuration): Promise<Email> {
     ...
     */
    public sendEmailSourceOptional(sendEmailOptions: SendEmailOptions, inboxId?: string, useDomainPool?: boolean, options?: Configuration): Promise<void> {
        const result = this.api.sendEmailSourceOptional(sendEmailOptions, inboxId, useDomainPool, options);
        return result.toPromise();
    }
...
export class PromiseExpiredControllerApi {
     ...
     */
    public getExpiredInboxRecord(iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId: string, options?: Configuration): Promise<ExpiredInboxDto> {
        const result = this.api.getExpiredInboxRecord(iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId, options);
        return result.toPromise();
    }
...
export class PromiseExportControllerApi {
     ...
     */
    public exportEntities(exportType: 'INBOXES' | 'CONTACTS' | 'ATTACHMENTS' | 'EMAILS', apiKey: string, outputFormat: 'CSV_DEFAULT' | 'CSV_EXCEL', filter?: string, listSeparatorToken?: string, excludePreviouslyExported?: boolean, createdEarliestTime?: Date, createdOldestTime?: Date, options?: Configuration): Promise<Array<string>> {
...
export class PromiseInboxControllerApi {
     ...
     */
    public doesInboxExist(emailAddress: string, options?: Configuration): Promise<InboxExistsDto> {
        const result = this.api.doesInboxExist(emailAddress, options);
        return result.toPromise();
    }
     ...
     */
    public getAllInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', favourite?: boolean, search?: string, tag?: string, dEPRECATEDOptionallyFilterByTeamAccess?: boolean, since?: Date, before?: Date, options?: Configuration): Promise<PageInboxProjection> {
        const result = this.api.getAllInboxes(page, size, sort, favourite, search, tag, dEPRECATEDOptionallyFilterByTeamAccess, since, before, options);
        return result.toPromise();
    }
     ...
     * @param idOfInboxThatEmailsBelongsTo 
     */
    public getInboxEmailCount(idOfInboxThatEmailsBelongsTo: string, options?: Configuration): Promise<CountDto> {
        const result = this.api.getInboxEmailCount(idOfInboxThatEmailsBelongsTo, options);
        return result.toPromise();
    }
     ...
     */
    public getInboxEmailsPaginated(idOfInboxThatEmailsBelongsTo: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Promise<PageEmailPreview> {
        const result = this.api.getInboxEmailsPaginated(idOfInboxThatEmailsBelongsTo, page, size, sort, since, before, options);
        return result.toPromise();
    }
     ...
     * @param before Optional filter by sent before given date time
     */
    public getInboxSentEmails(inboxId: string, page?: number, optionalPageSizeInInboxSentEmailListPagination?: number, sort?: 'ASC' | 'DESC', searchFilter?: string, since?: Date, before?: Date, options?: Configuration): Promise<PageSentEmailProjection> {
        const result = this.api.getInboxSentEmails(inboxId, page, optionalPageSizeInInboxSentEmailListPagination, sort, searchFilter, since, before, options);
        return result.toPromise();
    }
     ...
     * Get inbox tags
     */
    public getInboxTags(options?: Configuration): Promise<Set<string>> {
     ...
     * @param before Optional filter by created before given date time
     */
    public getInboxes(size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Promise<Array<InboxDto>> {
        const result = this.api.getInboxes(size, sort, since, before, options);
        return result.toPromise();
    }
     ...
     * @param before Optional filter by created before given date time
     */
    public listInboxTrackingPixels(inboxId: string, page?: number, optionalPageSizeInInboxTrackingPixelListPagination?: number, sort?: 'ASC' | 'DESC', searchFilter?: string, since?: Date, before?: Date, options?: Configuration): Promise<PageTrackingPixelProjection> {
        const result = this.api.listInboxTrackingPixels(inboxId, page, optionalPageSizeInInboxTrackingPixelListPagination, sort, searchFilter, since, before, options);
        return result.toPromise();
    }
     ...
     * @param sendEmailOptions 
     */
    public sendEmail(iDOfTheInboxYouWantToSendTheEmailFrom: string, sendEmailOptions: SendEmailOptions, options?: Configuration): Promise<void> {
        const result = this.api.sendEmail(iDOfTheInboxYouWantToSendTheEmailFrom, sendEmailOptions, options);
        return result.toPromise();
    }
     ...
     * @param sendEmailOptions 
     */
    public sendEmailAndConfirm(iDOfTheInboxYouWantToSendTheEmailFrom: string, sendEmailOptions: SendEmailOptions, options?: Configuration): Promise<SentEmailDto> {
        const result = this.api.sendEmailAndConfirm(iDOfTheInboxYouWantToSendTheEmailFrom, sendEmailOptions, options);
        return result.toPromise();
    }
...
export class PromiseInboxRulesetControllerApi {
     ...
     * @param createInboxRulesetOptions 
     */
    public createNewInboxRuleset(inboxId: string, createInboxRulesetOptions: CreateInboxRulesetOptions, options?: Configuration): Promise<InboxRulesetDto> {
        const result = this.api.createNewInboxRuleset(inboxId, createInboxRulesetOptions, options);
        return result.toPromise();
    }
...
export class PromiseMissedEmailControllerApi {
     ...
     * @param before Filter by created at before the given timestamp
     */
    public waitForNthMissedEmail(index: number, inboxId?: string, timeout?: number, since?: Date, before?: Date, options?: Configuration): Promise<MissedEmail> {
...
export class PromiseWebhookControllerApi {
     ...
     */
    public getAllWebhookResults(page?: number, size?: number, sort?: 'ASC' | 'DESC', searchFilter?: string, since?: Date, before?: Date, unseenOnly?: boolean, options?: Configuration): Promise<PageWebhookResult> {
        const result = this.api.getAllWebhookResults(page, size, sort, searchFilter, since, before, unseenOnly, options);
        return result.toPromise();
    }
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getAllWebhooks(page?: number, size?: number, sort?: 'ASC' | 'DESC', searchFilter?: string, since?: Date, before?: Date, options?: Configuration): Promise<PageWebhookProjection> {
        const result = this.api.getAllWebhooks(page, size, sort, searchFilter, since, before, options);
        return result.toPromise();
    }
     ...
     * @param unseenOnly Filter for unseen exceptions only
     */
    public getWebhookResults(webhookId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', searchFilter?: string, since?: Date, before?: Date, unseenOnly?: boolean, options?: Configuration): Promise<PageWebhookResult> {
        const result = this.api.getWebhookResults(webhookId, page, size, sort, searchFilter, since, before, unseenOnly, options);
        return result.toPromise();
    }
