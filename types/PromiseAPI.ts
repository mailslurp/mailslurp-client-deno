...
import { ObservableApiInternalControllerApi } from './ObservableAPI.ts';

import { ApiInternalControllerApiRequestFactory, ApiInternalControllerApiResponseProcessor} from "../apis/ApiInternalControllerApi.ts";
export class PromiseApiInternalControllerApi {
    private api: ObservableApiInternalControllerApi

    public constructor(
        configuration: Configuration,
        requestFactory?: ApiInternalControllerApiRequestFactory,
        responseProcessor?: ApiInternalControllerApiResponseProcessor
    ) {
        this.api = new ObservableApiInternalControllerApi(configuration, requestFactory, responseProcessor);
    }
     ...
     */
    public getSamlUserOrCreate(key: string, getOrCreateSamlUserOptions: GetOrCreateSamlUserOptions, options?: Configuration): Promise<UserDto> {
        const result = this.api.getSamlUserOrCreate(key, getOrCreateSamlUserOptions, options);
        return result.toPromise();
    }
...
export class PromiseCommonActionsControllerApi {
     ...
     * @param favourite 
     */
    public createNewEmailAddress(allowTeamAccess?: boolean, useDomainPool?: boolean, expiresAt?: Date, expiresIn?: number, emailAddress?: string, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', description?: string, name?: string, tags?: Array<string>, favourite?: boolean, options?: Configuration): Promise<InboxDto> {
     ...
     * @param favourite 
     */
    public createRandomInbox(allowTeamAccess?: boolean, useDomainPool?: boolean, expiresAt?: Date, expiresIn?: number, emailAddress?: string, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', description?: string, name?: string, tags?: Array<string>, favourite?: boolean, options?: Configuration): Promise<InboxDto> {
        const result = this.api.createRandomInbox(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, options);
        return result.toPromise();
    }
...
export class PromiseWebhookControllerApi {
     ...
     * @param eventName 
     */
    public getTestWebhookPayload(eventName?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'BOUNCE' | 'BOUNCE_RECIPIENT', options?: Configuration): Promise<AbstractWebhookPayload> {
