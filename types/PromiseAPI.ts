...
export class PromiseBounceControllerApi {
     ...
     */
    public getBouncedEmail(id: string, options?: Configuration): Promise<Bounce> {
     ...
     */
    public getBouncedRecipient(id: string, options?: Configuration): Promise<BounceRecipient> {
