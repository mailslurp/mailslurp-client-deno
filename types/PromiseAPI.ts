...
export class PromiseWebhookControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllWebhookResults(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<PageWebhookResult> {
        const result = this.api.getAllWebhookResults(page, size, sort, options);
        return result.toPromise();
    }
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getWebhookResults(webhookId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<PageWebhookResult> {
        const result = this.api.getWebhookResults(webhookId, page, size, sort, options);
        return result.toPromise();
    }
