...
export class PromisePhoneControllerApi {
     ...
     * Get a phone number by name
     */
    public getPhoneNumberByName(options?: Configuration): Promise<PhoneNumberDto> {
        const result = this.api.getPhoneNumberByName(options);
        return result.toPromise();
    }
     ...
     * Get a phone number by phone number
     */
    public getPhoneNumberByPhoneNumber(options?: Configuration): Promise<PhoneNumberDto> {
        const result = this.api.getPhoneNumberByPhoneNumber(options);
        return result.toPromise();
    }
...
import { ObservableSseControllerApi } from './ObservableAPI.ts';

import { SseControllerApiRequestFactory, SseControllerApiResponseProcessor} from "../apis/SseControllerApi.ts";
export class PromiseSseControllerApi {
    private api: ObservableSseControllerApi

    public constructor(
        configuration: Configuration,
        requestFactory?: SseControllerApiRequestFactory,
        responseProcessor?: SseControllerApiResponseProcessor
    ) {
        this.api = new ObservableSseControllerApi(configuration, requestFactory, responseProcessor);
    }

    /**
     * @param xApiKey 
     */
    public streamEvents(xApiKey: string, options?: Configuration): Promise<Array<string>> {
        const result = this.api.streamEvents(xApiKey, options);
        return result.toPromise();
    }
