...
export class PromiseAIControllerApi {
     ...
     */
    public createTransformer(options: AITranformCreateOptions, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<PageAITransformProjection> {
        const result = this.api.createTransformer(options, page, size, sort, options);
     ...
     */
    public createTransformer1(aITranformCreateOptions: AITranformCreateOptions, options?: Configuration): Promise<AITransformDto> {
        const result = this.api.createTransformer1(aITranformCreateOptions, options);
        return result.toPromise();
    }
...
export class PromiseAttachmentControllerApi {
     ...
     */
    public getAttachments(page?: number, size?: number, sort?: 'ASC' | 'DESC', fileNameFilter?: string, since?: Date, before?: Date, inboxId?: string, emailId?: string, sentEmailId?: string, options?: Configuration): Promise<PageAttachmentEntity> {
        const result = this.api.getAttachments(page, size, sort, fileNameFilter, since, before, inboxId, emailId, sentEmailId, options);
        return result.toPromise();
    }
     ...
     * @param inlineObject 
     */
    public uploadMultipartForm(contentId?: string, contentType?: string, filename?: string, contentTypeHeader?: string, xFilename?: string, xFilenameRaw?: string, xFilesize?: number, inlineObject?: InlineObject, options?: Configuration): Promise<Array<string>> {
        const result = this.api.uploadMultipartForm(contentId, contentType, filename, contentTypeHeader, xFilename, xFilenameRaw, xFilesize, inlineObject, options);
        return result.toPromise();
    }
...
export class PromiseEmailControllerApi {
     ...
     */
    public getEmailsOffsetPaginated(inboxId?: Array<string>, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, searchFilter?: string, since?: Date, before?: Date, favourited?: boolean, syncConnectors?: boolean, plusAddressId?: string, options?: Configuration): Promise<PageEmailProjection> {
        const result = this.api.getEmailsOffsetPaginated(inboxId, page, size, sort, unreadOnly, searchFilter, since, before, favourited, syncConnectors, plusAddressId, options);
        return result.toPromise();
    }
...
export class PromiseMFAControllerApi {
     ...
     */
    public createTotpDeviceForCustom(createTotpDeviceOtpAuthUrlOptions: CreateTotpDeviceOtpAuthUrlOptions, options?: Configuration): Promise<TotpDeviceDto> {
        const result = this.api.createTotpDeviceForCustom(createTotpDeviceOtpAuthUrlOptions, options);
        return result.toPromise();
    }
...
export class PromiseSmsControllerApi {
     ...
     * @param favourite Optionally filter results for favourites only
     */
    public getAllSmsMessages(phoneNumber?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, search?: string, favourite?: boolean, options?: Configuration): Promise<PageSmsProjection> {
        const result = this.api.getAllSmsMessages(phoneNumber, page, size, sort, since, before, search, favourite, options);
        return result.toPromise();
    }
...
export class PromiseWebhookControllerApi {
     ...
     * @param event 
     */
    public getJsonSchemaForWebhookEvent(event: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'DELIVERY_STATUS' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS' | 'NEW_GUEST_USER', options?: Configuration): Promise<JSONSchemaDto> {
     ...
     * @param eventName 
     */
    public getTestWebhookPayload(eventName?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'DELIVERY_STATUS' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS' | 'NEW_GUEST_USER', options?: Configuration): Promise<AbstractWebhookPayload> {
