...
export class PromiseInboxForwarderControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllInboxForwarderEvents(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<PageInboxForwarderEvents> {
        const result = this.api.getAllInboxForwarderEvents(page, size, sort, options);
        return result.toPromise();
    }
