...
import { DeliveryStatus } from '../models/DeliveryStatus.ts';
...
import { SmsMessage } from '../models/SmsMessage.ts';
...
export class PromiseInboxControllerApi {
     ...
     */
    public getAllInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', favourite?: boolean, search?: string, tag?: string, teamAccess?: boolean, since?: Date, before?: Date, options?: Configuration): Promise<PageInboxProjection> {
        const result = this.api.getAllInboxes(page, size, sort, favourite, search, tag, teamAccess, since, before, options);
        return result.toPromise();
    }
...
export class PromiseSentEmailsControllerApi {
     ...
     * @param deliveryId 
     */
    public getSentDeliveryStatus(deliveryId: string, options?: Configuration): Promise<DeliveryStatus> {
...
export class PromiseSmsControllerApi {
     ...
     * @param smsId 
     */
    public getSmsMessage(smsId: string, options?: Configuration): Promise<SmsMessage> {
