...
export class PromiseWebhookControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllWebhookResults(before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<PageWebhookResult> {
        const result = this.api.getAllWebhookResults(before, page, searchFilter, since, size, sort, options);
        return result.toPromise();
    }
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getWebhookResults(webhookId: string, before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<PageWebhookResult> {
        const result = this.api.getWebhookResults(webhookId, before, page, searchFilter, since, size, sort, options);
        return result.toPromise();
    }
