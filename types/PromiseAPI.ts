...
export class PromiseWaitForControllerApi {
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public waitForMatchingEmail(matchOptions: MatchOptions, count?: number, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Promise<Array<EmailPreview> | void> {
        const result = this.api.waitForMatchingEmail(matchOptions, count, delay, inboxId, since, sort, timeout, unreadOnly, options);
        return result.toPromise();
    }
...
export class PromiseWebhookControllerApi {
     ...
     */
    public getTestWebhookPayload(eventName?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED', options?: Configuration): Promise<AbstractWebhookPayload> {
     ...
     */
    public getWebhookResult(webhookResultId: string, options?: Configuration): Promise<WebhookResultEntity> {
