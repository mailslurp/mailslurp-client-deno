...
export class PromiseMissedEmailControllerApi {
     ...
     */
    public waitForNthMissedEmail(inboxId: string, timeout: number, index?: number, options?: Configuration): Promise<MissedEmail> {
        const result = this.api.waitForNthMissedEmail(inboxId, timeout, index, options);
        return result.toPromise();
    }
