...
export class PromiseAttachmentControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAttachments(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<PageAttachmentEntity> {
        const result = this.api.getAttachments(page, size, sort, options);
        return result.toPromise();
    }
...
export class PromiseWebhookControllerApi {
     ...
     */
    public getTestWebhookPayload(options?: Configuration): Promise<WebhookPayload> {
        const result = this.api.getTestWebhookPayload(options);
        return result.toPromise();
    }
