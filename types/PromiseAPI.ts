...
export class PromiseBounceControllerApi {
     ...
     */
    public getBouncedEmail(id: string, options?: Configuration): Promise<void | Bounce> {
     ...
     */
    public getBouncedEmail1(id: string, options?: Configuration): Promise<BounceRecipient | void> {
        const result = this.api.getBouncedEmail1(id, options);
        return result.toPromise();
    }
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getBouncedEmails(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<void | PageBouncedEmail> {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getBouncedRecipients(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<void | PageBouncedRecipients> {
