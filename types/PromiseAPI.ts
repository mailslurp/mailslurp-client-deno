...
import { InboxRulesetProjection } from '../models/InboxRulesetProjection.ts';
...
import { PageInboxRulesetProjection } from '../models/PageInboxRulesetProjection.ts';
...
export class PromiseInboxControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public listInboxRulesets(inboxId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<void> {
        const result = this.api.listInboxRulesets(inboxId, page, size, sort, options);
        return result.toPromise();
    }
...
export class PromiseInboxRulesetControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getInboxRulesets(inboxId?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<PageInboxRulesetProjection> {
        const result = this.api.getInboxRulesets(inboxId, page, size, sort, options);
        return result.toPromise();
    }
...
export class PromiseMissedEmailControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllMissedEmails(page?: number, searchFilter?: string, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<PageMissedEmailProjection> {
        const result = this.api.getAllMissedEmails(page, searchFilter, size, sort, options);
        return result.toPromise();
    }
