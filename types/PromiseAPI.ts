...
export class PromiseInboxControllerApi {
     ...
     */
    public createInboxRuleset(inboxId: string, createInboxRulesetOptions: CreateInboxRulesetOptions, options?: Configuration): Promise<void> {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public listInboxRulesets(inboxId: string, page?: number, searchFilter?: string, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<void> {
...
export class PromiseTrackingControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllTrackingPixels(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Promise<PageTrackingPixelProjection> {
        const result = this.api.getAllTrackingPixels(page, size, sort, options);
        return result.toPromise();
    }
...
export class PromiseWebhookControllerApi {
     ...
     */
    public getTestWebhookPayload(eventName?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT', options?: Configuration): Promise<AbstractWebhookPayload> {
