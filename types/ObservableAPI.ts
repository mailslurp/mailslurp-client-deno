...
export class ObservableAttachmentControllerApi {
     ...
     * @param attachmentId ID of attachment
     */
    public downloadAttachmentAsBytes(attachmentId: string, options?: Configuration): Observable<Array<string>> {
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getAttachments1(page?: number, size?: number, sort?: 'ASC' | 'DESC', fileNameFilter?: string, since?: Date, before?: Date, options?: Configuration): Observable<PageAttachmentEntity> {
        const requestContextPromise = this.requestFactory.getAttachments1(page, size, sort, fileNameFilter, since, before, options);
     ...
     */
    public uploadAttachmentBytes(requestBody: Array<string>, contentType?: string, filename?: string, options?: Configuration): Observable<Array<string>> {
        const requestContextPromise = this.requestFactory.uploadAttachmentBytes(requestBody, contentType, filename, options);
...
export class ObservableCommonActionsControllerApi {
     ...
     * @param favourite 
     */
    public createNewEmailAddress(allowTeamAccess?: boolean, useDomainPool?: boolean, expiresAt?: Date, expiresIn?: number, emailAddress?: string, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', description?: string, name?: string, tags?: Set<string>, favourite?: boolean, options?: Configuration): Observable<InboxDto> {
        const requestContextPromise = this.requestFactory.createNewEmailAddress(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, options);
     ...
     * @param favourite 
     */
    public createNewEmailAddress1(allowTeamAccess?: boolean, useDomainPool?: boolean, expiresAt?: Date, expiresIn?: number, emailAddress?: string, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', description?: string, name?: string, tags?: Set<string>, favourite?: boolean, options?: Configuration): Observable<InboxDto> {
        const requestContextPromise = this.requestFactory.createNewEmailAddress1(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, options);
...
export class ObservableEmailControllerApi {
     ...
     */
    public downloadAttachment(emailId: string, attachmentId: string, apiKey?: string, options?: Configuration): Observable<Array<string>> {
     ...
     * @param emailId ID of email
     */
    public downloadBodyBytes(emailId: string, options?: Configuration): Observable<Array<string>> {
     ...
     * @param emailId ID of email
     */
    public getAttachments(emailId: string, options?: Configuration): Observable<Array<AttachmentMetaData>> {
        const requestContextPromise = this.requestFactory.getAttachments(emailId, options);
     ...
     */
    public getLatestEmail(inboxIds?: Set<string>, options?: Configuration): Observable<Email> {
     ...
     */
    public sendEmailSourceOptional(sendEmailOptions: SendEmailOptions, inboxId?: string, useDomainPool?: boolean, options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.sendEmailSourceOptional(sendEmailOptions, inboxId, useDomainPool, options);
...
export class ObservableExpiredControllerApi {
     ...
     */
    public getExpiredInboxRecord(iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId: string, options?: Configuration): Observable<ExpiredInboxDto> {
        const requestContextPromise = this.requestFactory.getExpiredInboxRecord(iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId, options);
...
export class ObservableInboxControllerApi {
     ...
     */
    public getAllInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', favourite?: boolean, search?: string, tag?: string, dEPRECATEDOptionallyFilterByTeamAccess?: boolean, since?: Date, before?: Date, options?: Configuration): Observable<PageInboxProjection> {
        const requestContextPromise = this.requestFactory.getAllInboxes(page, size, sort, favourite, search, tag, dEPRECATEDOptionallyFilterByTeamAccess, since, before, options);
     ...
     * @param idOfInboxThatEmailsBelongsTo 
     */
    public getInboxEmailCount(idOfInboxThatEmailsBelongsTo: string, options?: Configuration): Observable<CountDto> {
        const requestContextPromise = this.requestFactory.getInboxEmailCount(idOfInboxThatEmailsBelongsTo, options);
     ...
     */
    public getInboxEmailsPaginated(idOfInboxThatEmailsBelongsTo: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Observable<PageEmailPreview> {
        const requestContextPromise = this.requestFactory.getInboxEmailsPaginated(idOfInboxThatEmailsBelongsTo, page, size, sort, since, before, options);
     ...
     * @param before Optional filter by sent before given date time
     */
    public getInboxSentEmails(inboxId: string, page?: number, optionalPageSizeInInboxSentEmailListPagination?: number, sort?: 'ASC' | 'DESC', searchFilter?: string, since?: Date, before?: Date, options?: Configuration): Observable<PageSentEmailProjection> {
        const requestContextPromise = this.requestFactory.getInboxSentEmails(inboxId, page, optionalPageSizeInInboxSentEmailListPagination, sort, searchFilter, since, before, options);
     ...
     * Get inbox tags
     */
    public getInboxTags(options?: Configuration): Observable<Set<string>> {
     ...
     * @param before Optional filter by created before given date time
     */
    public listInboxTrackingPixels(inboxId: string, page?: number, optionalPageSizeInInboxTrackingPixelListPagination?: number, sort?: 'ASC' | 'DESC', searchFilter?: string, since?: Date, before?: Date, options?: Configuration): Observable<PageTrackingPixelProjection> {
        const requestContextPromise = this.requestFactory.listInboxTrackingPixels(inboxId, page, optionalPageSizeInInboxTrackingPixelListPagination, sort, searchFilter, since, before, options);
     ...
     * @param sendEmailOptions 
     */
    public sendEmail(iDOfTheInboxYouWantToSendTheEmailFrom: string, sendEmailOptions: SendEmailOptions, options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.sendEmail(iDOfTheInboxYouWantToSendTheEmailFrom, sendEmailOptions, options);
     ...
     * @param sendEmailOptions 
     */
    public sendEmailAndConfirm(iDOfTheInboxYouWantToSendTheEmailFrom: string, sendEmailOptions: SendEmailOptions, options?: Configuration): Observable<SentEmailDto> {
        const requestContextPromise = this.requestFactory.sendEmailAndConfirm(iDOfTheInboxYouWantToSendTheEmailFrom, sendEmailOptions, options);
