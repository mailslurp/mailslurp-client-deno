...
export class ObservableAliasControllerApi {
     ...
     */
    public getAliasEmails(aliasId: string, before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageEmailProjection> {
        const requestContextPromise = this.requestFactory.getAliasEmails(aliasId, before, page, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAliasThreads(aliasId: string, before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageThreadProjection> {
        const requestContextPromise = this.requestFactory.getAliasThreads(aliasId, before, page, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAliases(before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageAlias> {
        const requestContextPromise = this.requestFactory.getAliases(before, page, since, size, sort, options);
     ...
     */
    public updateAlias(aliasId: string, updateAliasOptions: UpdateAliasOptions, options?: Configuration): Observable<void | AliasDto> {
...
export class ObservableAttachmentControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAttachments(before?: Date, fileNameFilter?: string, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageAttachmentEntity> {
        const requestContextPromise = this.requestFactory.getAttachments(before, fileNameFilter, page, since, size, sort, options);
     ...
     */
    public uploadAttachmentBytes(contentType?: string, filename?: string, byteArray?: string, options?: Configuration): Observable<Array<string>> {
        const requestContextPromise = this.requestFactory.uploadAttachmentBytes(contentType, filename, byteArray, options);
...
export class ObservableBounceControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getBouncedEmails(before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageBouncedEmail> {
        const requestContextPromise = this.requestFactory.getBouncedEmails(before, page, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getBouncedRecipients(before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageBouncedRecipients> {
        const requestContextPromise = this.requestFactory.getBouncedRecipients(before, page, since, size, sort, options);
...
export class ObservableCommonActionsControllerApi {
     ...
     */
    public createNewEmailAddress(allowTeamAccess?: boolean, description?: string, emailAddress?: string, expiresAt?: Date, expiresIn?: number, favourite?: boolean, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', name?: string, tags?: Array<string>, useDomainPool?: boolean, options?: Configuration): Observable<Inbox> {
        const requestContextPromise = this.requestFactory.createNewEmailAddress(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, inboxType, name, tags, useDomainPool, options);
     ...
     * @param useDomainPool useDomainPool
     */
    public createNewEmailAddress1(allowTeamAccess?: boolean, description?: string, emailAddress?: string, expiresAt?: Date, expiresIn?: number, favourite?: boolean, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', name?: string, tags?: Array<string>, useDomainPool?: boolean, options?: Configuration): Observable<Inbox> {
        const requestContextPromise = this.requestFactory.createNewEmailAddress1(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, inboxType, name, tags, useDomainPool, options);
...
export class ObservableContactControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllContacts(before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageContactProjection> {
        const requestContextPromise = this.requestFactory.getAllContacts(before, page, since, size, sort, options);
...
export class ObservableEmailControllerApi {
     ...
     */
    public getEmailsPaginated(before?: Date, inboxId?: Array<string>, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: Configuration): Observable<PageEmailProjection> {
        const requestContextPromise = this.requestFactory.getEmailsPaginated(before, inboxId, page, searchFilter, since, size, sort, unreadOnly, options);
     ...
     * @param unreadOnly Optional filter for unread emails only. All emails are considered unread until they are viewed in the dashboard or requested directly
     */
    public getOrganizationEmailsPaginated(before?: Date, inboxId?: Array<string>, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: Configuration): Observable<PageEmailProjection> {
        const requestContextPromise = this.requestFactory.getOrganizationEmailsPaginated(before, inboxId, page, searchFilter, since, size, sort, unreadOnly, options);
     ...
     */
    public markAsRead(emailId: string, read?: boolean, options?: Configuration): Observable<void | EmailPreview> {
...
export class ObservableExpiredControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getExpiredInboxes(before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageExpiredInboxRecordProjection> {
        const requestContextPromise = this.requestFactory.getExpiredInboxes(before, page, since, size, sort, options);
...
export class ObservableGroupControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllGroups(before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageGroupProjection> {
        const requestContextPromise = this.requestFactory.getAllGroups(before, page, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getGroupWithContactsPaginated(groupId: string, before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageContactProjection> {
        const requestContextPromise = this.requestFactory.getGroupWithContactsPaginated(groupId, before, page, since, size, sort, options);
...
export class ObservableInboxControllerApi {
     ...
     */
    public flushExpired(before?: Date, options?: Configuration): Observable<FlushExpiredInboxesResult | void> {
     ...
     */
    public getAllInboxes(before?: Date, favourite?: boolean, page?: number, search?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', tag?: string, teamAccess?: boolean, options?: Configuration): Observable<PageInboxProjection> {
        const requestContextPromise = this.requestFactory.getAllInboxes(before, favourite, page, search, since, size, sort, tag, teamAccess, options);
     ...
     */
    public getEmails(inboxId: string, before?: Date, delayTimeout?: number, limit?: number, minCount?: number, retryTimeout?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: Configuration): Observable<Array<EmailPreview>> {
        const requestContextPromise = this.requestFactory.getEmails(inboxId, before, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getInboxEmailsPaginated(inboxId: string, before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageEmailPreview> {
        const requestContextPromise = this.requestFactory.getInboxEmailsPaginated(inboxId, before, page, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getInboxSentEmails(inboxId: string, before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageSentEmailProjection> {
        const requestContextPromise = this.requestFactory.getInboxSentEmails(inboxId, before, page, searchFilter, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getInboxes(before?: Date, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<Array<Inbox>> {
        const requestContextPromise = this.requestFactory.getInboxes(before, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getOrganizationInboxes(before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageOrganizationInboxProjection> {
        const requestContextPromise = this.requestFactory.getOrganizationInboxes(before, page, searchFilter, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public listInboxRulesets(inboxId: string, before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageInboxRulesetDto> {
        const requestContextPromise = this.requestFactory.listInboxRulesets(inboxId, before, page, searchFilter, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public listInboxTrackingPixels(inboxId: string, before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageTrackingPixelProjection> {
        const requestContextPromise = this.requestFactory.listInboxTrackingPixels(inboxId, before, page, searchFilter, since, size, sort, options);
...
export class ObservableInboxForwarderControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getInboxForwarders(before?: Date, inboxId?: string, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageInboxForwarderDto> {
        const requestContextPromise = this.requestFactory.getInboxForwarders(before, inboxId, page, searchFilter, since, size, sort, options);
...
export class ObservableInboxRulesetControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getInboxRulesets(before?: Date, inboxId?: string, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageInboxRulesetDto> {
        const requestContextPromise = this.requestFactory.getInboxRulesets(before, inboxId, page, searchFilter, since, size, sort, options);
...
export class ObservableMissedEmailControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllMissedEmails(before?: Date, inboxId?: string, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageMissedEmailProjection> {
        const requestContextPromise = this.requestFactory.getAllMissedEmails(before, inboxId, page, searchFilter, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllUnknownMissedEmails(before?: Date, inboxId?: string, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageUnknownMissedEmailProjection> {
        const requestContextPromise = this.requestFactory.getAllUnknownMissedEmails(before, inboxId, page, searchFilter, since, size, sort, options);
     ...
     */
    public waitForNthMissedEmail(before?: Date, inboxId?: string, index?: number, since?: Date, timeout?: number, options?: Configuration): Observable<MissedEmail> {
        const requestContextPromise = this.requestFactory.waitForNthMissedEmail(before, inboxId, index, since, timeout, options);
...
export class ObservableSentEmailsControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllSentTrackingPixels(before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageTrackingPixelProjection> {
        const requestContextPromise = this.requestFactory.getAllSentTrackingPixels(before, page, searchFilter, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getSentEmailTrackingPixels(id: string, before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageTrackingPixelProjection> {
        const requestContextPromise = this.requestFactory.getSentEmailTrackingPixels(id, before, page, searchFilter, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getSentEmails(before?: Date, inboxId?: string, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageSentEmailProjection> {
        const requestContextPromise = this.requestFactory.getSentEmails(before, inboxId, page, searchFilter, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getSentOrganizationEmails(before?: Date, inboxId?: string, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageSentEmailProjection> {
        const requestContextPromise = this.requestFactory.getSentOrganizationEmails(before, inboxId, page, searchFilter, since, size, sort, options);
...
export class ObservableTemplateControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllTemplates(before?: Date, page?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageTemplateProjection> {
        const requestContextPromise = this.requestFactory.getAllTemplates(before, page, since, size, sort, options);
...
export class ObservableTrackingControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllTrackingPixels(before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageTrackingPixelProjection> {
        const requestContextPromise = this.requestFactory.getAllTrackingPixels(before, page, searchFilter, since, size, sort, options);
...
export class ObservableWaitForControllerApi {
     ...
     */
    public waitForEmailCount(before?: Date, count?: number, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Observable<Array<EmailPreview>> {
        const requestContextPromise = this.requestFactory.waitForEmailCount(before, count, delay, inboxId, since, sort, timeout, unreadOnly, options);
     ...
     * @param unreadOnly Optional filter for unread only.
     */
    public waitForLatestEmail(before?: Date, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Observable<Email> {
        const requestContextPromise = this.requestFactory.waitForLatestEmail(before, delay, inboxId, since, sort, timeout, unreadOnly, options);
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public waitForMatchingEmails(matchOptions: MatchOptions, before?: Date, count?: number, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Observable<Array<EmailPreview> | void> {
        const requestContextPromise = this.requestFactory.waitForMatchingEmails(matchOptions, before, count, delay, inboxId, since, sort, timeout, unreadOnly, options);
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public waitForMatchingFirstEmail(matchOptions: MatchOptions, before?: Date, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Observable<Email | void> {
        const requestContextPromise = this.requestFactory.waitForMatchingFirstEmail(matchOptions, before, delay, inboxId, since, sort, timeout, unreadOnly, options);
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public waitForNthEmail(before?: Date, delay?: number, inboxId?: string, index?: number, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Observable<Email> {
        const requestContextPromise = this.requestFactory.waitForNthEmail(before, delay, inboxId, index, since, sort, timeout, unreadOnly, options);
...
export class ObservableWebhookControllerApi {
     ...
     */
    public getAllWebhookResults(before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', unseenOnly?: boolean, options?: Configuration): Observable<PageWebhookResult> {
        const requestContextPromise = this.requestFactory.getAllWebhookResults(before, page, searchFilter, since, size, sort, unseenOnly, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllWebhooks(before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageWebhookProjection> {
        const requestContextPromise = this.requestFactory.getAllWebhooks(before, page, searchFilter, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getInboxWebhooksPaginated(inboxId: string, before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageWebhookProjection> {
        const requestContextPromise = this.requestFactory.getInboxWebhooksPaginated(inboxId, before, page, searchFilter, since, size, sort, options);
     ...
     */
    public getTestWebhookPayload(eventName?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ', options?: Configuration): Observable<AbstractWebhookPayload> {
     ...
     * @param unseenOnly Filter for unseen exceptions only
     */
    public getWebhookResults(webhookId: string, before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', unseenOnly?: boolean, options?: Configuration): Observable<PageWebhookResult> {
        const requestContextPromise = this.requestFactory.getWebhookResults(webhookId, before, page, searchFilter, since, size, sort, unseenOnly, options);
     ...
     * @param inboxId inboxId
     */
    public getWebhookResultsUnseenErrorCount(inboxId: string, options?: Configuration): Observable<UnseenErrorCountDto> {
        const requestContextPromise = this.requestFactory.getWebhookResultsUnseenErrorCount(inboxId, options);
     ...
     * @param webhookResultId Webhook Result ID
     */
    public redriveWebhookResult(webhookResultId: string, options?: Configuration): Observable<void | WebhookRedriveResult> {
