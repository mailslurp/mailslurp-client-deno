...
export class ObservablePhoneControllerApi {
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getPhoneNumbers(page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Observable<PagePhoneNumberProjection> {
        const requestContextPromise = this.requestFactory.getPhoneNumbers(page, size, sort, since, before, options);
     ...
     */
    public testPhoneNumberSendSms(phoneNumberId: string, testPhoneNumberOptions: TestPhoneNumberOptions, options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.testPhoneNumberSendSms(phoneNumberId, testPhoneNumberOptions, options);
...
export class ObservableWebhookControllerApi {
     ...
     * @param event 
     */
    public getJsonSchemaForWebhookEvent(event: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS', options?: Configuration): Observable<JSONSchemaDto> {
     ...
     * @param eventName 
     */
    public getTestWebhookPayload(eventName?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS', options?: Configuration): Observable<AbstractWebhookPayload> {
