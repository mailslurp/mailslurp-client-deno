...
import { CreateConnectorImapFetchOptions } from '../models/CreateConnectorImapFetchOptions.ts';
...
export class ObservableAliasControllerApi {
     ...
     * @param threadId 
     */
    public getThread(threadId: string, options?: Configuration): Observable<ThreadProjection> {
     ...
     * @param before Optional filter by sent before given date time
     */
    public getThreadsPaginated(page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Observable<PageThreadProjection> {
...
export class ObservableAttachmentControllerApi {
     ...
     */
    public getAttachments(page?: number, size?: number, sort?: 'ASC' | 'DESC', fileNameFilter?: string, since?: Date, before?: Date, inboxId?: string, options?: Configuration): Observable<PageAttachmentEntity> {
        const requestContextPromise = this.requestFactory.getAttachments(page, size, sort, fileNameFilter, since, before, inboxId, options);
     ...
     * @param filename2 
     */
    public uploadAttachmentBytes(contentType?: string, contentType2?: string, contentId?: string, filename?: string, filename2?: string, options?: Configuration): Observable<Array<string>> {
        const requestContextPromise = this.requestFactory.uploadAttachmentBytes(contentType, contentType2, contentId, filename, filename2, options);
     ...
     * @param inlineObject 
     */
    public uploadMultipartForm(contentId?: string, contentType?: string, filename?: string, xFilename?: string, inlineObject?: InlineObject, options?: Configuration): Observable<Array<string>> {
        const requestContextPromise = this.requestFactory.uploadMultipartForm(contentId, contentType, filename, xFilename, inlineObject, options);
...
export class ObservableConnectorControllerApi {
     ...
     */
    public createConnector(createConnectorOptions: CreateConnectorOptions, options?: Configuration): Observable<ConnectorDto> {
        const requestContextPromise = this.requestFactory.createConnector(createConnectorOptions, options);
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getAllConnectorSyncEvents(page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Observable<PageConnectorSyncEvents> {
        const requestContextPromise = this.requestFactory.getAllConnectorSyncEvents(page, size, sort, since, before, options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getAllConnectorSyncEvents(rsp)));
            }));
    }
     ...
     * @param id 
     */
    public getConnectorSyncEvent(id: string, options?: Configuration): Observable<ConnectorSyncEventDto> {
        const requestContextPromise = this.requestFactory.getConnectorSyncEvent(id, options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getConnectorSyncEvent(rsp)));
            }));
    }
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getConnectorSyncEvents(id: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Observable<PageConnectorSyncEvents> {
        const requestContextPromise = this.requestFactory.getConnectorSyncEvents(id, page, size, sort, since, before, options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getConnectorSyncEvents(rsp)));
            }));
    }
     ...
     * @param id 
     */
    public syncConnector(id: string, options?: Configuration): Observable<ConnectorSyncRequestResult> {
        const requestContextPromise = this.requestFactory.syncConnector(id, options);
...
export class ObservableEmailControllerApi {
     ...
     */
    public getEmailContentPart(emailId: string, contentType: string, options?: Configuration): Observable<EmailContentPartResult> {
        const requestContextPromise = this.requestFactory.getEmailContentPart(emailId, contentType, options);
     ...
     */
    public getEmailHTML(emailId: string, decode?: boolean, replaceCidImages?: boolean, options?: Configuration): Observable<string> {
        const requestContextPromise = this.requestFactory.getEmailHTML(emailId, decode, replaceCidImages, options);
     ...
     * @param replaceCidImages 
     */
    public getEmailHTMLJson(emailId: string, decode?: boolean, replaceCidImages?: boolean, options?: Configuration): Observable<EmailHtmlDto> {
        const requestContextPromise = this.requestFactory.getEmailHTMLJson(emailId, decode, replaceCidImages, options);
     ...
     */
    public getEmailsOffsetPaginated(inboxId?: Array<string>, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, searchFilter?: string, since?: Date, before?: Date, options?: Configuration): Observable<PageEmailProjection> {
        const requestContextPromise = this.requestFactory.getEmailsOffsetPaginated(inboxId, page, size, sort, unreadOnly, searchFilter, since, before, options);
     ...
     */
    public searchEmails(searchEmailsOptions: SearchEmailsOptions, options?: Configuration): Observable<PageEmailProjection> {
        const requestContextPromise = this.requestFactory.searchEmails(searchEmailsOptions, options);
...
export class ObservableInboxControllerApi {
     ...
     */
    public getAllInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', favourite?: boolean, search?: string, tag?: string, teamAccess?: boolean, since?: Date, before?: Date, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', inboxFunction?: 'ALIAS' | 'THREAD' | 'CATCH_ALL' | 'CONNECTOR', domainId?: string, options?: Configuration): Observable<PageInboxProjection> {
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getAllScheduledJobs(page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Observable<PageScheduledJobs> {
        const requestContextPromise = this.requestFactory.getAllScheduledJobs(page, size, sort, since, before, options);
     ...
     * @param before Optional filter by created before given date time
     */
    public getInboxes(size?: number, sort?: 'ASC' | 'DESC', since?: Date, excludeCatchAllInboxes?: boolean, before?: Date, options?: Configuration): Observable<Array<InboxDto>> {
        const requestContextPromise = this.requestFactory.getInboxes(size, sort, since, excludeCatchAllInboxes, before, options);
...
export class ObservableInboxForwarderControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllInboxForwarderEvents(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageInboxForwarderEvents> {
        const requestContextPromise = this.requestFactory.getAllInboxForwarderEvents(page, size, sort, options);
...
export class ObservablePhoneControllerApi {
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getPhoneNumbers(phoneCountry?: 'US' | 'GB' | 'AU', page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Observable<PagePhoneNumberProjection> {
        const requestContextPromise = this.requestFactory.getPhoneNumbers(phoneCountry, page, size, sort, since, before, options);
...
export class ObservableSmsControllerApi {
     ...
     */
    public getSmsMessagesPaginated(phoneNumber?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, since?: Date, before?: Date, options?: Configuration): Observable<PageSmsProjection> {
        const requestContextPromise = this.requestFactory.getSmsMessagesPaginated(phoneNumber, page, size, sort, unreadOnly, since, before, options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getSmsMessagesPaginated(rsp)));
            }));
    }
...
export class ObservableWebhookControllerApi {
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getAllAccountWebhooks(page?: number, size?: number, sort?: 'ASC' | 'DESC', eventType?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'DELIVERY_STATUS' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS', since?: Date, before?: Date, options?: Configuration): Observable<PageWebhookProjection> {
        const requestContextPromise = this.requestFactory.getAllAccountWebhooks(page, size, sort, eventType, since, before, options);
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getAllWebhooks(page?: number, size?: number, sort?: 'ASC' | 'DESC', searchFilter?: string, since?: Date, inboxId?: string, phoneId?: string, before?: Date, options?: Configuration): Observable<PageWebhookProjection> {
        const requestContextPromise = this.requestFactory.getAllWebhooks(page, size, sort, searchFilter, since, inboxId, phoneId, before, options);
     ...
     * @param event 
     */
    public getJsonSchemaForWebhookEvent(event: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'DELIVERY_STATUS' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS', options?: Configuration): Observable<JSONSchemaDto> {
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getPhoneNumberWebhooksPaginated(phoneId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Observable<PageWebhookProjection> {
        const requestContextPromise = this.requestFactory.getPhoneNumberWebhooksPaginated(phoneId, page, size, sort, since, before, options);
     ...
     * @param eventName 
     */
    public getTestWebhookPayload(eventName?: 'EMAIL_RECEIVED' | 'NEW_EMAIL' | 'NEW_CONTACT' | 'NEW_ATTACHMENT' | 'EMAIL_OPENED' | 'EMAIL_READ' | 'DELIVERY_STATUS' | 'BOUNCE' | 'BOUNCE_RECIPIENT' | 'NEW_SMS', options?: Configuration): Observable<AbstractWebhookPayload> {
