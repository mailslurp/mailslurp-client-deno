...
import { WebhookPayload } from '../models/WebhookPayload.ts';
...
export class ObservableAttachmentControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAttachments(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageAttachmentEntity> {
        const requestContextPromise = this.requestFactory.getAttachments(page, size, sort, options);
...
export class ObservableEmailControllerApi {
     ...
     */
    public forwardEmail(emailId: string, forwardEmailOptions: ForwardEmailOptions, options?: Configuration): Observable<void> {
     ...
     */
    public getEmailsPaginated(inboxId?: Array<string>, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: Configuration): Observable<PageEmailProjection> {
        const requestContextPromise = this.requestFactory.getEmailsPaginated(inboxId, page, size, sort, unreadOnly, options);
     ...
     * @param unreadOnly Optional filter for unread emails only. All emails are considered unread until they are viewed in the dashboard or requested directly
     */
    public getOrganizationEmailsPaginated(inboxId?: Array<string>, page?: number, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: Configuration): Observable<PageEmailProjection> {
        const requestContextPromise = this.requestFactory.getOrganizationEmailsPaginated(inboxId, page, size, sort, unreadOnly, options);
...
export class ObservableInboxControllerApi {
     ...
     */
    public createInbox(allowTeamAccess?: boolean, description?: string, emailAddress?: string, expiresAt?: Date, expiresIn?: number, favourite?: boolean, name?: string, tags?: Array<string>, useDomainPool?: boolean, options?: Configuration): Observable<Inbox> {
        const requestContextPromise = this.requestFactory.createInbox(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, name, tags, useDomainPool, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getInboxSentEmails(inboxId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageSentEmailProjection> {
        const requestContextPromise = this.requestFactory.getInboxSentEmails(inboxId, page, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getOrganizationInboxes(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageOrganizationInboxProjection> {
        const requestContextPromise = this.requestFactory.getOrganizationInboxes(page, size, sort, options);
...
export class ObservableMissedEmailControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllMissedEmails(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageMissedEmailProjection> {
        const requestContextPromise = this.requestFactory.getAllMissedEmails(page, size, sort, options);
...
export class ObservableSentEmailsControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getSentEmails(inboxId?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageSentEmailProjection> {
        const requestContextPromise = this.requestFactory.getSentEmails(inboxId, page, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getSentOrganizationEmails(inboxId?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageSentEmailProjection> {
        const requestContextPromise = this.requestFactory.getSentOrganizationEmails(inboxId, page, size, sort, options);
...
export class ObservableWebhookControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllWebhooks(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageWebhookProjection> {
        const requestContextPromise = this.requestFactory.getAllWebhooks(page, size, sort, options);
     ...
     */
    public getTestWebhookPayload(options?: Configuration): Observable<WebhookPayload> {
        const requestContextPromise = this.requestFactory.getTestWebhookPayload(options);
