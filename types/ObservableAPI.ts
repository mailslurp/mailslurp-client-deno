...
export class ObservableInboxForwarderControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllInboxForwarderEvents(page?: number, size?: number, inboxId?: string, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageInboxForwarderEvents> {
        const requestContextPromise = this.requestFactory.getAllInboxForwarderEvents(page, size, inboxId, sort, options);
