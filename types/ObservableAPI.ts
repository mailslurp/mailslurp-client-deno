...
export class ObservableApiInternalControllerApi {
    private requestFactory: ApiInternalControllerApiRequestFactory;
    private responseProcessor: ApiInternalControllerApiResponseProcessor;
    private configuration: Configuration;
    ...
    public constructor(
        ...
        this.configuration = configuration;
        this.requestFactory = requestFactory || new ApiInternalControllerApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new ApiInternalControllerApiResponseProcessor();
    }
     ...
     */
    public getSamlUserOrCreate(key: string, getOrCreateSamlUserOptions: GetOrCreateSamlUserOptions, options?: Configuration): Observable<UserDto> {
        const requestContextPromise = this.requestFactory.getSamlUserOrCreate(key, getOrCreateSamlUserOptions, options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getSamlUserOrCreate(rsp)));
            }));
    }
...
export class ObservableCommonActionsControllerApi {
     ...
     * @param favourite 
     */
    public createNewEmailAddress(allowTeamAccess?: boolean, useDomainPool?: boolean, expiresAt?: Date, expiresIn?: number, emailAddress?: string, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', description?: string, name?: string, tags?: Array<string>, favourite?: boolean, options?: Configuration): Observable<InboxDto> {
     ...
     * @param favourite 
     */
    public createRandomInbox(allowTeamAccess?: boolean, useDomainPool?: boolean, expiresAt?: Date, expiresIn?: number, emailAddress?: string, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', description?: string, name?: string, tags?: Array<string>, favourite?: boolean, options?: Configuration): Observable<InboxDto> {
        const requestContextPromise = this.requestFactory.createRandomInbox(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, options);
