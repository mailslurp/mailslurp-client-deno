...
export class ObservableBounceControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getBouncedEmails(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageBouncedEmail> {
        const requestContextPromise = this.requestFactory.getBouncedEmails(page, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getBouncedRecipients(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageBouncedRecipients> {
        const requestContextPromise = this.requestFactory.getBouncedRecipients(page, size, sort, options);
...
export class ObservableInboxControllerApi {
     ...
     */
    public getEmails(inboxId: string, delayTimeout?: number, limit?: number, minCount?: number, retryTimeout?: number, since?: Date, size?: number, sort?: 'ASC' | 'DESC', unreadOnly?: boolean, options?: Configuration): Observable<Array<EmailPreview>> {
        const requestContextPromise = this.requestFactory.getEmails(inboxId, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly, options);
...
export class ObservableMissedEmailControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllUnknownMissedEmails(inboxId?: string, page?: number, searchFilter?: string, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageUnknownMissedEmailProjection> {
        const requestContextPromise = this.requestFactory.getAllUnknownMissedEmails(inboxId, page, searchFilter, size, sort, options);
...
export class ObservableWaitForControllerApi {
     ...
     */
    public waitForEmailCount(count?: number, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Observable<Array<EmailPreview>> {
        const requestContextPromise = this.requestFactory.waitForEmailCount(count, delay, inboxId, since, sort, timeout, unreadOnly, options);
     ...
     * @param unreadOnly Optional filter for unread only.
     */
    public waitForLatestEmail(delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Observable<Email> {
        const requestContextPromise = this.requestFactory.waitForLatestEmail(delay, inboxId, since, sort, timeout, unreadOnly, options);
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public waitForMatchingEmails(matchOptions: MatchOptions, count?: number, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Observable<Array<EmailPreview> | void> {
        const requestContextPromise = this.requestFactory.waitForMatchingEmails(matchOptions, count, delay, inboxId, since, sort, timeout, unreadOnly, options);
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public waitForMatchingFirstEmail(matchOptions: MatchOptions, delay?: number, inboxId?: string, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Observable<Email | void> {
        const requestContextPromise = this.requestFactory.waitForMatchingFirstEmail(matchOptions, delay, inboxId, since, sort, timeout, unreadOnly, options);
     ...
     * @param unreadOnly Optional filter for unread only
     */
    public waitForNthEmail(delay?: number, inboxId?: string, index?: number, since?: Date, sort?: 'ASC' | 'DESC', timeout?: number, unreadOnly?: boolean, options?: Configuration): Observable<Email> {
        const requestContextPromise = this.requestFactory.waitForNthEmail(delay, inboxId, index, since, sort, timeout, unreadOnly, options);
