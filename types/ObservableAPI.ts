...
export class ObservableApiUserControllerApi {
    private requestFactory: ApiUserControllerApiRequestFactory;
    private responseProcessor: ApiUserControllerApiResponseProcessor;
    private configuration: Configuration;
    ...
    public constructor(
        ...
        this.configuration = configuration;
        this.requestFactory = requestFactory || new ApiUserControllerApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new ApiUserControllerApiResponseProcessor();
    }
...
export class ObservableCommonActionsControllerApi {
    ...
    public createNewEmailAddress(allowTeamAccess?: boolean, useDomainPool?: boolean, expiresAt?: Date, expiresIn?: number, emailAddress?: string, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', description?: string, name?: string, tags?: Array<string>, favourite?: boolean, virtualInbox?: boolean, useShortAddress?: boolean, options?: Configuration): Observable<InboxDto> {
        const requestContextPromise = this.requestFactory.createNewEmailAddress(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, options);
    ...
    public createRandomInbox(allowTeamAccess?: boolean, useDomainPool?: boolean, expiresAt?: Date, expiresIn?: number, emailAddress?: string, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', description?: string, name?: string, tags?: Array<string>, favourite?: boolean, virtualInbox?: boolean, useShortAddress?: boolean, options?: Configuration): Observable<InboxDto> {
        const requestContextPromise = this.requestFactory.createRandomInbox(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, options);
...
export class ObservableInboxControllerApi {
     ...
     */
    public createInbox(emailAddress?: string, tags?: Array<string>, name?: string, description?: string, useDomainPool?: boolean, favourite?: boolean, expiresAt?: Date, expiresIn?: number, allowTeamAccess?: boolean, inboxType?: 'HTTP_INBOX' | 'SMTP_INBOX', virtualInbox?: boolean, useShortAddress?: boolean, options?: Configuration): Observable<InboxDto> {
        const requestContextPromise = this.requestFactory.createInbox(emailAddress, tags, name, description, useDomainPool, favourite, expiresAt, expiresIn, allowTeamAccess, inboxType, virtualInbox, useShortAddress, options);
...
export class ObservablePhoneControllerApi {
     ...
     * @param before Filter by created at before the given timestamp
     */
    public getPhoneNumbers(phoneCountry?: 'US' | 'GB', page?: number, size?: number, sort?: 'ASC' | 'DESC', since?: Date, before?: Date, options?: Configuration): Observable<PagePhoneNumberProjection> {
