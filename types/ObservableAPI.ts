...
export class ObservableAIControllerApi {
     ...
     */
    public generateStructuredContentFromAttachment(generateStructuredContentAttachmentOptions: GenerateStructuredContentAttachmentOptions, options?: Configuration): Observable<StructuredContentResult> {
     ...
     */
    public generateStructuredContentFromEmail(generateStructuredContentEmailOptions: GenerateStructuredContentEmailOptions, options?: Configuration): Observable<StructuredContentResult> {
