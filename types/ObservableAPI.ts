...
export class ObservableMFAControllerApi {
     ...
     * @param at 
     */
    public getTotpDeviceCode(id: string, at?: Date, options?: Configuration): Observable<TotpDeviceCodeDto> {
        const requestContextPromise = this.requestFactory.getTotpDeviceCode(id, at, options);
