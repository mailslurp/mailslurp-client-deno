...
export class ObservableBounceControllerApi {
     ...
     */
    public getBouncedEmail(id: string, options?: Configuration): Observable<Bounce> {
     ...
     */
    public getBouncedRecipient(id: string, options?: Configuration): Observable<BounceRecipient> {
