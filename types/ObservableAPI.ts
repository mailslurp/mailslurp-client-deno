...
export class ObservableWebhookControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllWebhookResults(before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageWebhookResult> {
        const requestContextPromise = this.requestFactory.getAllWebhookResults(before, page, searchFilter, since, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getWebhookResults(webhookId: string, before?: Date, page?: number, searchFilter?: string, since?: Date, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageWebhookResult> {
        const requestContextPromise = this.requestFactory.getWebhookResults(webhookId, before, page, searchFilter, since, size, sort, options);
