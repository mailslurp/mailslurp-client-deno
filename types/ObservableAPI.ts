...
export class ObservablePhoneControllerApi {
     ...
     * Get a phone number by name
     */
    public getPhoneNumberByName(options?: Configuration): Observable<PhoneNumberDto> {
        const requestContextPromise = this.requestFactory.getPhoneNumberByName(options);
     ...
     * Get a phone number by phone number
     */
    public getPhoneNumberByPhoneNumber(options?: Configuration): Observable<PhoneNumberDto> {
        const requestContextPromise = this.requestFactory.getPhoneNumberByPhoneNumber(options);
