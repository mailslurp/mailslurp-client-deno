...
export class ObservableInboxControllerApi {
     ...
     */
    public createInboxRuleset(inboxId: string, createInboxRulesetOptions: CreateInboxRulesetOptions, options?: Configuration): Observable<void> {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public listInboxRulesets(inboxId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<void> {
        const requestContextPromise = this.requestFactory.listInboxRulesets(inboxId, page, size, sort, options);
...
export class ObservableInboxRulesetControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getInboxRulesets(inboxId?: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageInboxRulesetProjection> {
        const requestContextPromise = this.requestFactory.getInboxRulesets(inboxId, page, size, sort, options);
...
export class ObservableMissedEmailControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllMissedEmails(page?: number, searchFilter?: string, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageMissedEmailProjection> {
        const requestContextPromise = this.requestFactory.getAllMissedEmails(page, searchFilter, size, sort, options);
