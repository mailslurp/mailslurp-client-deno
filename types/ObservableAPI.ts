...
export class ObservableBounceControllerApi {
     ...
     */
    public getBouncedEmail(id: string, options?: Configuration): Observable<void | Bounce> {
     ...
     */
    public getBouncedEmail1(id: string, options?: Configuration): Observable<BounceRecipient | void> {
        const requestContextPromise = this.requestFactory.getBouncedEmail1(id, options);
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.getBouncedEmail1(rsp)));
            }));
    }
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getBouncedEmails(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<void | PageBouncedEmail> {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getBouncedRecipients(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<void | PageBouncedRecipients> {
