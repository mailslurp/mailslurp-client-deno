...
export class ObservableInboxControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public listInboxRulesets(inboxId: string, page?: number, searchFilter?: string, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<void> {
...
export class ObservableMissedEmailControllerApi {
     ...
     */
    public waitForNthMissedEmail(inboxId: string, timeout: number, index?: number, options?: Configuration): Observable<MissedEmail> {
        const requestContextPromise = this.requestFactory.waitForNthMissedEmail(inboxId, timeout, index, options);
...
export class ObservableTrackingControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllTrackingPixels(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageTrackingPixelProjection> {
        const requestContextPromise = this.requestFactory.getAllTrackingPixels(page, size, sort, options);
