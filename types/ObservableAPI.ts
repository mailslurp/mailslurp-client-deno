...
export class ObservableWebhookControllerApi {
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getAllWebhookResults(page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageWebhookResult> {
        const requestContextPromise = this.requestFactory.getAllWebhookResults(page, size, sort, options);
     ...
     * @param sort Optional createdAt sort direction ASC or DESC
     */
    public getWebhookResults(webhookId: string, page?: number, size?: number, sort?: 'ASC' | 'DESC', options?: Configuration): Observable<PageWebhookResult> {
        const requestContextPromise = this.requestFactory.getWebhookResults(webhookId, page, size, sort, options);
