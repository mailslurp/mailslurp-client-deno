...
import { EntityFavouriteItemProjection } from './EntityFavouriteItemProjection.ts';
...
*/
export class PageEntityFavouriteItems {
    ...
    static getAttributeTypeMap() {
        return PageEntityFavouriteItems.attributeTypeMap;
    }
