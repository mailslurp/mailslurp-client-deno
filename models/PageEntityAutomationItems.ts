...
import { EntityAutomationItemProjection } from './EntityAutomationItemProjection.ts';
...
*/
export class PageEntityAutomationItems {
    ...
    static getAttributeTypeMap() {
        return PageEntityAutomationItems.attributeTypeMap;
    }
