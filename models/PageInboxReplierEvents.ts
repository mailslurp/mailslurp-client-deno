...
import { InboxReplierEventProjection } from './InboxReplierEventProjection.ts';
...
*/
export class PageInboxReplierEvents {
    ...
    static getAttributeTypeMap() {
        return PageInboxReplierEvents.attributeTypeMap;
    }
