...
export * from './CreateConnectorImapFetchOptions.ts';
export * from './CreateConnectorImapOptions.ts';
...
import { ConnectorDto   , ConnectorDtoConnectorTypeEnum  , ConnectorDtoConnectorAuthTypeEnum   , ConnectorDtoSyncScheduleTypeEnum            } from './ConnectorDto.ts';
import { ConnectorProjection    , ConnectorProjectionConnectorTypeEnum  , ConnectorProjectionSyncScheduleTypeEnum     } from './ConnectorProjection.ts';
...
import { CreateConnectorImapFetchOptions } from './CreateConnectorImapFetchOptions.ts';
import { CreateConnectorImapOptions } from './CreateConnectorImapOptions.ts';
import { CreateConnectorOptions, CreateConnectorOptionsConnectorTypeEnum  , CreateConnectorOptionsConnectorAuthTypeEnum     , CreateConnectorOptionsSyncScheduleTypeEnum     } from './CreateConnectorOptions.ts';
...
let enumsMap: Set<string> = new Set<string>([
    ...
    "ConnectorDtoConnectorTypeEnum",
    "ConnectorDtoConnectorAuthTypeEnum",
    "ConnectorDtoSyncScheduleTypeEnum",
    "ConnectorProjectionConnectorTypeEnum",
    "ConnectorProjectionSyncScheduleTypeEnum",
    "ConnectorSyncEventDtoSyncStatusEnum",
    "ConnectorSyncEventProjectionSyncStatusEnum",
    "CreateConnectorOptionsConnectorTypeEnum",
    "CreateConnectorOptionsConnectorAuthTypeEnum",
