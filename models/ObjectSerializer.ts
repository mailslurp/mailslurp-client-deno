...
export * from './InboxRulesetProjection.ts';
...
export * from './PageInboxRulesetProjection.ts';
...
import { InboxRulesetProjection, InboxRulesetProjectionActionEnum  , InboxRulesetProjectionHandlerEnum    , InboxRulesetProjectionScopeEnum    } from './InboxRulesetProjection.ts';
...
import { PageInboxRulesetProjection } from './PageInboxRulesetProjection.ts';
...
let enumsMap: Set<string> = new Set<string>([
    ...
    "InboxRulesetProjectionActionEnum",
    "InboxRulesetProjectionHandlerEnum",
    "InboxRulesetProjectionScopeEnum",
...
let typeMap: {[index: string]: any} = {
    ...
    "InboxRulesetProjection": InboxRulesetProjection,
