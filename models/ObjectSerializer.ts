...
export * from './ConnectorSyncRequestResultExceptionCauseSuppressed.ts';
...
import { ConnectorSyncRequestResultExceptionCauseSuppressed } from './ConnectorSyncRequestResultExceptionCauseSuppressed.ts';
...
import { InboxDto          , InboxDtoInboxTypeEnum     } from './InboxDto.ts';
...
import { InboxPreview        , InboxPreviewInboxTypeEnum     } from './InboxPreview.ts';
...
let typeMap: {[index: string]: any} = {
    ...
    "ConnectorSyncRequestResultExceptionCauseSuppressed": ConnectorSyncRequestResultExceptionCauseSuppressed,
