...
import { WebhookResultEntity , WebhookResultEntityHttpMethodEnum        , WebhookResultEntityResultTypeEnum    , WebhookResultEntityWebhookEventEnum     } from './WebhookResultEntity.ts';
...
let enumsMap: Set<string> = new Set<string>([
    ...
    "WebhookResultEntityResultTypeEnum",
