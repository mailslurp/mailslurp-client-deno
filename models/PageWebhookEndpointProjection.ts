...
import { WebhookEndpointProjection } from './WebhookEndpointProjection.ts';
...
*/
export class PageWebhookEndpointProjection {
    ...
    static getAttributeTypeMap() {
        return PageWebhookEndpointProjection.attributeTypeMap;
    }
