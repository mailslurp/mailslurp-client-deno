...
import { EmailFeatureFamilyStatistics } from './EmailFeatureFamilyStatistics.ts';
import { Set } from './Set.ts';
import { HttpFile } from '../http/http.ts';

export class EmailFeatureOverview {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "feature",
            "baseName": "feature",
            "type": "EmailFeatureOverviewFeatureEnum",
            "format": ""
        },
        {
            "name": "title",
        ...
        },
        {
            "name": "category",
            "baseName": "category",
            "type": "EmailFeatureOverviewCategoryEnum",
            "format": ""
        },
        {
            "name": "notes",
        ...
        {
            "name": "notesNumbers",
            "baseName": "notesNumbers",
            "type": "{ [key: string]: string; }",
            "format": ""
        },
        {
            "name": "featureStatistics",
            "baseName": "featureStatistics",
        ...
        },
        {
            "name": "statuses",
            "baseName": "statuses",
            "type": "Set<EmailFeatureOverviewStatusesEnum>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return EmailFeatureOverview.attributeTypeMap;
    }
