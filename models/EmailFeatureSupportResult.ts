...
import { EmailFeatureOverview } from './EmailFeatureOverview.ts';
import { EmailFeatureSupportStatusPercentage } from './EmailFeatureSupportStatusPercentage.ts';
import { Set } from './Set.ts';
import { HttpFile } from '../http/http.ts';

export class EmailFeatureSupportResult {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            ...
            "baseName": "detectedFeatures",
            "type": "Set<EmailFeatureSupportResultDetectedFeaturesEnum>",
            "format": ""
        },
        {
            "name": "featureOverviews",
            "baseName": "featureOverviews",
            "type": "Array<EmailFeatureOverview>",
            "format": ""
        },
        {
            "name": "featurePercentages",
            "baseName": "featurePercentages",
            "type": "Array<EmailFeatureSupportStatusPercentage>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return EmailFeatureSupportResult.attributeTypeMap;
    }
